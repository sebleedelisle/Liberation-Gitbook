...
3.  **Настройте zones:**\
    В _OUTPUT_ view можно проверить zones. Переключайтесь между лазерами клавишей Tab или нажмите одну из пронумерованных кнопок в верхней части view. Настройте каждую zone как требуется или добавьте новые zones. См. [Output view](../output-view/ "mention").
...
5.  **Подключитесь к controllers:** когда будете готовы подключить лазеры и начать работу, откройте панель _Controller Assignment_. См. [Назначение controller](controller-assignment.md "mention").
