...
Liberation では、すべての DMX 出力が Art-Net を使用して送信されます。Art-Net 対応デバイスを直接制御することもできますし、**Art-Net node**（Art-Net を標準 DMX に変換する小型の機器）を接続することもできます。これにより、機器自体が Art-Net に対応していない従来の DMX 照明やエフェクトも制御できます。
{% endhint %}
