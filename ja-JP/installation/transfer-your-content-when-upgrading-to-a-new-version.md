...
Liberation はコンテンツを作業フォルダーに保存します（[作業フォルダーの場所](../troubleshooting/where-to-find-the-working-folder.md "mention") を参照）。この作業フォルダーは、新しいバージョンがリリースされるたびに変わります。古いバージョンの作業ファイルを新しいバージョンでも使いたい場合は、次の手順を行います。&#x20;
