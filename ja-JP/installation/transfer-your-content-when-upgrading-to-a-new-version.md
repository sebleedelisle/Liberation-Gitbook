...
Liberation はコンテンツを作業フォルダーに保存します（[working folder の場所](../troubleshooting/where-to-find-the-working-folder.md "mention") を参照）。この作業フォルダーは、新しいバージョンがリリースされるたびに変わります。古いバージョンの作業ファイルを新しいバージョンでも使いたい場合は、次の手順を行います。&#x20;
