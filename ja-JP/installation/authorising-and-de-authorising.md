...
これで Liberation のインストールが認証され、レーザーに出力できるようになりました。おめでとうございます！ただし、レーザーをアームする前に、[getting-started.md](../getting-started.md) と [setting-up-lasers.md](../setting-up/setting-up-lasers.md) をお読みください。
