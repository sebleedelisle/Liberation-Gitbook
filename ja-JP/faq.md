...
有料ライセンスが支払い後に更新されるたびに、Liberation をインターネットに接続して内部ライセンスを更新する必要があります。月額の自動更新ライセンスの場合は、毎月接続する必要があります。

#### **次回の支払い後にコンピューターをインターネットに接続できない場合はどうなりますか？**

有料ライセンスの更新後、Liberation は内部ライセンスを更新するためにインターネットへ接続する 7 日間の猶予期間を提供します。その期間を過ぎると、Liberation は _Free_ モードに戻ります。

#### **クレジットカードの有効期限が切れた場合はどうなりますか？**

決済プロバイダーからメール通知が届きます。その後、カード情報を更新する必要があります。Web サイトにログインし、ライセンスページの _UPDATE CARD DETAILS_、または _Billing and payments_ の _Update_ を使用してください。

#### **ライセンスの自動更新をキャンセルするにはどうすればよいですか？**

Web サイトにログインし、[_Your licences_](https://liberationlaser.com/account/my-products) ページを開き、管理したいライセンスを選択して、_CANCEL PAYMENTS_ をクリックします。有料ライセンスは現在の有料期間の終了まで有効なままです。以後の支払いは発生しません。
