...
6. **software masks を追加します** - Liberation 内の software masks は、カメラやプロジェクターを保護するために使用できますが、人を保護する目的で物理的な遮蔽の代わりに使用しては**絶対にいけません**。ソフトウェアやハードウェアに完全なものはないため、software masks を使用する前にリスクを理解しておいてください。
