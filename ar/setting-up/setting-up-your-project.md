...
عند فتح Liberation للمرة الأولى، سيكون مضبوطًا على الإعدادات الافتراضية. لكنك غالبًا سترغب في تعديلها لتتطابق بشكل أفضل مع إعدادك الخاص.
...
3.  **اضبط zones:**\
    في عرض _OUTPUT_ يمكنك التحقق من zones. تنقّل بين أجهزة الليزر باستخدام مفتاح Tab أو انقر أحد الأزرار المرقّمة في أعلى العرض. اضبط كل zone حسب الحاجة، أو أضف zones جديدة. راجع [Output view](../output-view/ "mention").
...
5.  **اتصل بـ controllers لديك:** عندما تكون جاهزًا لتوصيل أجهزة الليزر والبدء، افتح لوحة _Controller Assignment_. راجع [تعيين controller](controller-assignment.md "mention").
