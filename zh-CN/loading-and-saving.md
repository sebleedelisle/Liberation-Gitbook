...
* MIDI notes node 和 Sound Input Oscillator 中使用的音频/MIDI 输入设置（也_会_保存 MIDI send/receive 设置以及 timecode 的音频输入）
* 界面缩放&#x20;
...
保存并加载 Art-Net 节点及其 IP 地址，同时包含 DMX zones 和所有 DMX presets。
