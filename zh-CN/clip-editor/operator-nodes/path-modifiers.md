...
* **Colour** – 点的颜色。若启用 _Inherit Colour_ 则忽略此项，见下方。_另见_ [颜色设置与 HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – 选择渲染质量。_见_ [渲染配置](../fundamentals/render-profile.md)
...
* **Colour** – 裁剪点颜色。_另见_ [颜色设置与 HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – 选择点使用的渲染配置。_见_ [渲染配置](../fundamentals/render-profile.md)
