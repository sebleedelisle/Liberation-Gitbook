...
通常从一个或多个 [Creators](creator-nodes.md) 开始，然后从左到右连接 [Operator nodes](operator-nodes/) 对内容进行处理。你会发现当 Creator 和 Operator 靠近时会自动连接，也可以拖开以断开。&#x20;
...
Oscillators 总有 _range_ 设置，用于控制属性的最小/最大值。_Wave Oscillators_ 还带 _duration_ 设置，用于决定变化速度。更多信息见 [Wave oscillators](oscillators/wave-oscillators.md "mention")。&#x20;
