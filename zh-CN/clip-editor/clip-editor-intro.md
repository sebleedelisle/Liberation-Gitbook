...
Oscillator 始终具有 _range_ 设置，用来控制要调整属性的最小值和最大值。_Wave Oscillators_ 始终具有 _duration_ 设置，用来决定 Oscillator 改变数值的速度。更多信息请参见 [Wave oscillators](oscillators/wave-oscillators.md "mention")。
