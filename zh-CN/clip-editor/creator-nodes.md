...
* **Render profile** - 见 [渲染配置](fundamentals/render-profile.md)
* **Colour** - 点的颜色。见 [颜色设置与 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 和 **y** 位置 - 见 [坐标系统](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - 见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - 见 [渲染配置](fundamentals/render-profile.md)
* **Size** - 线的长度
* **Colour** - 线的颜色。见 [颜色设置与 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 和 **y** 位置 - 见 [坐标系统](fundamentals/co-ordinate-system.md)
* **rotation** - 线的角度（度）
* **resolution** - 见 [分辨率](fundamentals/resolution.md)
...
* **Render profile** - 见 [渲染配置](fundamentals/render-profile.md)
* **radius** - 圆的半径
* **Colour** - 圆的颜色。见 [颜色设置与 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 和 **y** 位置 - 见 [坐标系统](fundamentals/co-ordinate-system.md)
* **resolution** - 见 [分辨率](fundamentals/resolution.md)
* **Fill state** - 见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - 见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - 见 [渲染配置](fundamentals/render-profile.md)
* **size** - 从中心到角的距离
* **Colour** - 多边形的颜色。见 [颜色设置与 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 和 **y** 位置 - 见 [坐标系统](fundamentals/co-ordinate-system.md)
* **rotation** - 形状旋转角度（度）
* **resolution** - 见 [分辨率](fundamentals/resolution.md)
* **Fill state** - 见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - 将任何填充形状作为 mask 处理，也就是填充为黑色。如果你的 SVG 中有任何填充形状，此设置会自动开启；如果没有填充形状，则会关闭。见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - 将任何填充形状作为 mask 处理，也就是填充为黑色。如果你的任一 SVG 中有填充形状，此设置会自动开启；如果都没有填充形状，则会关闭。见 [填充、Masks 与深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** 见 [颜色设置与 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 和 **y** 位置 - 见 [坐标系统](fundamentals/co-ordinate-system.md)
* **rotation** - 图像旋转角度（度）
* **resolution** - 见 [分辨率](fundamentals/resolution.md)
