...
右键点击 Clip 会出现该 Clip 的部分选项。关于菜单前几项的更多说明见 [Clip Editor 介绍](../clip-editor/clip-editor-intro.md "mention")、[Clip 设置](clip-settings.md "mention") 和 [Clip 分组](groups.md "mention")。&#x20;
