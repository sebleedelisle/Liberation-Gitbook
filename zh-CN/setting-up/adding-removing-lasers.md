...
或在 _Output_ 视图中点击 _+_ 按钮。 <br>

<figure><img src="../.gitbook/assets/Laser Output View (1).png" alt="" width="176"><figcaption></figcaption></figure>

添加新激光时，会自动为其创建一个 beam zone。请注意，激光和 zone 会按添加顺序排序。参见 [重新排序 beam zone](../output-view/re-ordering-beam-zones.md)。

在 _Laser Overview_ 面板中点击红色 “-” 按钮即可移除激光。注意：这样会丢失该激光的所有设置！

{% hint style="info" %}
如果你想从其他激光复制 zone 或其他设置，请使用 [在激光之间复制设置](copy-laser-settings.md)
{% endhint %}

{% hint style="info" %}
注意：当你执行删除激光等潜在危险操作时，会出现确认对话框。如果想跳过确认，请在点击按钮时按住 `Cmd / Ctrl`。务必谨慎使用！
{% endhint %}
