...
* 面板分为左右两部分：左侧是激光列表，右侧是可用控制器列表。如果列表里看不到你的控制器，点击 _REFRESH_ 按钮。若仍有问题，请参见 [故障排除](../troubleshooting/ "mention")。&#x20;
...
* 橙色方块 🟧 表示控制器连接不稳定，通常由网络问题引起，参见 [故障排除](../troubleshooting/ "mention")。
