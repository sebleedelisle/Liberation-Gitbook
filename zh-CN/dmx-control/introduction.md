...
在 Liberation 中，所有 DMX 输出都通过 Art-Net 发送。你可以直接控制兼容 Art-Net 的设备，也可以连接一个 **Art-Net 节点** ——一个将 Art-Net 转换回标准 DMX 的小盒子。这样即使设备本身不支持 Art-Net，也能通过 Liberation 控制传统 DMX 灯光与效果。
{% endhint %}
...
其中 18 台激光由内置 Ether Dream 控制，另有 12 组 6 头光束灯条 通过 Art-Net 和 DMX 控制。&#x20;
