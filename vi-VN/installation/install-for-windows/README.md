...
Sau khi có giấy phép trả phí đang hoạt động, bạn sẽ nhận được một liên kết, hoặc bạn có thể nhấp vào _Download_ trên trang [_Your licences_](https://liberationlaser.com/account/my-products).

Bạn sẽ thấy trang này:

<figure><img src="../../.gitbook/assets/account-download-page.png" alt=""><figcaption></figcaption></figure>

Nhấp vào _Download for Windows_ (số phiên bản có thể thay đổi), bạn sẽ thấy chỉ báo tải xuống hiển thị tiến trình (thường ở góc trên bên phải; ảnh chụp màn hình từ Chrome). Khi tải xong, mở thư mục tải xuống và nhấp vào tệp cài đặt vừa tải về.
...
Liberation bây giờ sẽ chạy! Để xuất ra laser, bạn cần hoàn tất [Cấp quyền và hủy cấp quyền](../authorising-and-de-authorising.md).
