...
Menu là nơi bạn tìm thấy tất cả tùy chọn nhập / xuất file và mở các panel. Bạn cũng sẽ tìm thấy tùy chọn ủy quyền máy tính bằng giấy phép của mình tại đây (trong _Liberation -> Authorise/Deauthorise this computer_).
