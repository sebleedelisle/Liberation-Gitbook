...
Panel ở bên phải Clip Deck hiển thị tám tham số theo ngữ cảnh. Khi một Clip được chọn, các điều khiển đầu tiên là _Shift X_, _Shift Y_ và _Zone Delay_ của Clip đang chọn, tiếp theo là các điều khiển _Spin_ và _Scale_ toàn cục.

Các tham số này cũng được phản chiếu sang những MIDI controller được hỗ trợ. Nếu không có Clip nào được chọn, các ô dành riêng cho Clip sẽ để trống. Nếu bạn giữ một nút nhóm, hai điều khiển đầu tiên sẽ chuyển thành thời gian fade in và fade out của nhóm đó.
...
Nếu bạn nhấp chuột phải vào một Clip, một menu sẽ xuất hiện với một số tùy chọn cho Clip đó. Xem [Giới thiệu Clip Editor](../clip-editor/clip-editor-intro.md "mention"), [Cài đặt Clip](clip-settings.md "mention") và [Nhóm](groups.md "mention") để biết thêm về một vài mục đầu tiên trong menu này.
