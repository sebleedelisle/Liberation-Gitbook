...
Tỷ lệ theo chiều ngang và chiều dọc; hai giá trị này được khóa cùng nhau trừ khi bạn nhấn `Shift`. Theo mặc định, các giá trị này cũng được gán vào núm APC40 Device Control 4 và 8, đồng thời xuất hiện trong panel bên phải Clip Deck.
...
Xoay toàn bộ nội dung quanh tâm. Giá trị dương xoay theo chiều kim đồng hồ, giá trị âm xoay ngược chiều kim đồng hồ. Bạn sẽ thấy thiết lập này ảnh hưởng đến biến đổi _Rotation_. Theo mặc định, thiết lập này được gán vào núm APC40 Device Control 3 và xuất hiện trong panel bên phải Clip Deck.

### Spin 3D

Xoay toàn bộ nội dung quanh trục Y (là một đường thẳng đứng ở giữa). Bạn sẽ thấy thiết lập này ảnh hưởng đến biến đổi _Rotation3D_. Theo mặc định, thiết lập này được gán vào núm APC40 Device Control 7 và xuất hiện trong panel bên phải Clip Deck.
