...
Các mục tiếp theo dùng để hiệu chỉnh cách lắp đặt laser để laser hoạt động nhất quán trong Liberation.
...
Xem [Bảng cài đặt đầu ra laser](./#copy-laser-settings).
...
{% hint style="info" %}
Cài đặt tốc độ này không thay đổi point rate; thay vào đó, nó điều chỉnh mức độ giãn cách giữa các điểm. Để biết thêm thông tin, xem [cách Liberation tạo nội dung laser](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
Bạn không cần phải chỉnh các mục này, nhưng nếu tò mò, hãy xem [cài đặt laser nâng cao](../../advanced/advanced-laser-settings.md)
