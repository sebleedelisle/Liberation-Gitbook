...
* Panel được chia làm hai phần: danh sách laser ở bên trái và danh sách các bộ điều khiển hiện có ở bên phải. Nếu bạn không thấy bộ điều khiển laser của mình trong danh sách, hãy nhấn nút _REFRESH_. Nếu vẫn gặp vấn đề, xem [khắc phục sự cố](../troubleshooting/ "mention").
...
* Ô vuông màu cam 🟧 nghĩa là bộ điều khiển đang gặp sự cố kết nối chập chờn. Nguyên nhân thường là do vấn đề mạng, xem [khắc phục sự cố](../troubleshooting/ "mention").
* Ô vuông màu đỏ 🟥 nghĩa là không thể kết nối tới bộ điều khiển, xem [khắc phục sự cố](../troubleshooting/ "mention").
