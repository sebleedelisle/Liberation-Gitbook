...
* **Render profile** - xem [Render profile](fundamentals/render-profile.md)
* **Colour** - màu của chấm. Xem [Cài đặt màu và HSB](fundamentals/colour-settings-and-hsb.md)
* Vị trí **x** và **y** - xem [Hệ tọa độ](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - màu của đường. Xem [Cài đặt màu và HSB](fundamentals/colour-settings-and-hsb.md)
* Vị trí **x** và **y** - xem [Hệ tọa độ](fundamentals/co-ordinate-system.md)
* **rotation** - góc của đường, tính bằng độ
* **resolution** - xem [Resolution](fundamentals/resolution.md)
...
* **Colour** - màu của hình tròn. Xem [Cài đặt màu và HSB](fundamentals/colour-settings-and-hsb.md)
* Vị trí **x** và **y** - xem [Hệ tọa độ](fundamentals/co-ordinate-system.md)
* **resolution** - xem [Resolution](fundamentals/resolution.md)
* **Fill state** - xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - màu của đa giác. Xem [Cài đặt màu và HSB](fundamentals/colour-settings-and-hsb.md)
* Vị trí **x** và **y** - xem [Hệ tọa độ](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - xử lý mọi hình có fill như một mask, tức là được tô bằng màu đen. Tùy chọn này sẽ được bật tự động nếu SVG của bạn có bất kỳ hình nào có fill. Nếu không có hình nào có fill, tùy chọn này sẽ bị tắt. Xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - xử lý mọi hình có fill như một mask, tức là được tô bằng màu đen. Tùy chọn này sẽ được bật tự động nếu bất kỳ SVG nào của bạn có hình có fill. Nếu không SVG nào có hình có fill, tùy chọn này sẽ bị tắt. Xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
...
{% hint style="info" %}
Để thêm phông vào Liberation, hãy sao chép các tệp .ttf hoặc .otf vào thư mục data/resources/fonts.
{% endhint %}
...
* **Fill state** - xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
* **size** - kích thước chữ
* **colour -** xem [Cài đặt màu và HSB](fundamentals/colour-settings-and-hsb.md)
* Vị trí **x** và **y** - xem [Hệ tọa độ](fundamentals/co-ordinate-system.md)
* **rotation** - góc xoay của hình ảnh, tính bằng độ
* **resolution** - xem [Resolution](fundamentals/resolution.md)
...
* **countdown** - một hệ thống đếm ngược (được triển khai khá vội!). Sẽ thay đổi mỗi 2 beat, vì vậy nếu bạn muốn tính theo giây, hãy đảm bảo đang ở 120bpm.
* **countdown start** - số mà bạn muốn bắt đầu đếm ngược từ đó
* _MOVE TO FRONT / MOVE TO BACK_ - xem [Fill, mask và sắp xếp độ sâu](fundamentals/fills-masks-and-depth-sorting.md)
