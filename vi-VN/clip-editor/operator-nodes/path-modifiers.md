...
* **Colour** – màu của các chấm. Bị bỏ qua nếu bật _Inherit Colour_, xem bên dưới. _Xem thêm_ [Cài đặt màu và HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – chọn chất lượng render. _Xem_ [Render profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – màu của các chấm tại điểm cắt. _Xem thêm_ [Cài đặt màu và HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – chọn render profile cho các chấm. _Xem_ [Render profile](../fundamentals/render-profile.md "mention")
