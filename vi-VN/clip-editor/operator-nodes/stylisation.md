...
* **prefill trails** – điền sẵn lịch sử vệt ngay khi Clip bắt đầu, thay vì chờ các tiếng vọng tích lũy trong vài nhịp đầu tiên.
...
* **Z** – xoay theo chiều kim đồng hồ/ngược chiều kim đồng hồ (giống như nghiêng đầu sang bên)
