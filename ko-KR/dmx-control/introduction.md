...
Liberation에서는 모든 DMX 출력이 Art-Net을 사용해 전송됩니다. Art-Net 호환 장치를 직접 제어하는 데 사용할 수 있으며, **Art-Net 노드**를 연결할 수도 있습니다. Art-Net 노드는 Art-Net을 표준 DMX로 다시 변환하는 작은 장치입니다. 즉, 장치 자체가 Art-Net을 지원하지 않더라도 기존 DMX 조명과 효과 장비를 계속 제어할 수 있습니다.
{% endhint %}
