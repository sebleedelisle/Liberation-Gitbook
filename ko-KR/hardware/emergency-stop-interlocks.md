...
이 때문에 레이저에는 레이저를 제어된 방식으로 비활성화하고 활성화하는 내장 인터록 및 원격 정지 시스템이 있습니다.
{% endhint %}

개인적으로 통제된 공간에서 레이저를 사용할 때도 **항상 원격 정지 버튼을 사용하세요**. 누군가 갑자기 레이저 경로로 들어올 수도 있고, 예상치 못한 강한 빔이 석고 마감재를 태우기 시작할 수도 있습니다(어떻게 알게 됐는지는 묻지 마세요).
