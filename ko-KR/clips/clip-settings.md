...
Clip을 오른쪽 클릭하면 해당 Clip에 대한 몇 가지 옵션이 포함된 메뉴가 나타납니다. 이 메뉴의 처음 몇 항목에 대한 자세한 내용은 [Clip Editor 소개](../clip-editor/clip-editor-intro.md), [Clip 설정](clip-settings.md) 및 [Clip 그룹](groups.md)을 참고하세요.
