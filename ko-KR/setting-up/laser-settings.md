...
[#copy-laser-settings](laser-settings.md#copy-laser-settings)를 참조하세요.
...
쇼 프로젝트 밖에서 point rate, 출력 각도, 스캐너 부하를 시험해 보고 싶다면 [🟩 스캐너 사양과 Liberation](../appendix-articles/scanner-specifications-and-liberation.md)을 참조하세요.
...
<div><figure><img src="../.gitbook/assets/Colour shift tails.jpeg" alt="" width="320"><figcaption><p>레이저 “꼬리” - Scanner Sync가 올바르게 설정되지 않은 상태</p></figcaption></figure> <figure><img src="../.gitbook/assets/Colour shift no tails.jpeg" alt="" width="320"><figcaption><p>레이저 “꼬리” 없음! Scanner Sync 양호!</p></figcaption></figure></div>
...
이 시스템을 사용해 레이저의 밝기 커브와 화이트 밸런스를 보정할 수 있습니다. [색상 보정](../advanced/colour-calibration.md)을 참조하세요.

#### Advanced settings

일반적으로 이 설정을 건드릴 필요는 없지만, 궁금하다면 [◼️ 고급 레이저 설정](../advanced/advanced-laser-settings.md)을 참조하세요.
