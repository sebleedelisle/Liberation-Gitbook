...
{% hint style="warning" %}
중요: 레이저를 arm 상태로 전환하기 전에 관련 위험을 반드시 이해하고, [레이저 설정하기](../setting-up/setting-up-lasers.md "mention") 장을 주의 깊게 확인하세요.
{% endhint %}
...
{% hint style="danger" %}
레이저를 arm 상태로 전환하기 전에 반드시 [레이저 설정하기](../setting-up/setting-up-lasers.md "mention") 장을 확인하세요.
{% endhint %}
...
레이저 설정 및 zoning에 대한 전체 가이드는 다음을 참조하세요: [레이저 설정하기](../setting-up/setting-up-lasers.md "mention")
