...
* **Colour** – 점의 색상입니다. _Inherit Colour_가 활성화되어 있으면 무시됩니다. 아래 내용을 참고하세요. _관련 항목_ [색상 설정 및 HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – 렌더링 품질을 선택합니다. _참조_ [렌더 프로필](../fundamentals/render-profile.md "mention")
...
* **Colour** – 트림 점의 색상입니다. _관련 항목_ [색상 설정 및 HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – 점에 사용할 렌더 프로필을 선택합니다. _참조_ [렌더 프로필](../fundamentals/render-profile.md "mention")
