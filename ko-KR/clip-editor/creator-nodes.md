...
* **Render profile** - [Render profile](fundamentals/render-profile.md) 참조
* **Colour** - 점의 색상입니다. [색상 설정 및 HSB](fundamentals/colour-settings-and-hsb.md) 참조
* **x** 및 **y** position - [좌표계](fundamentals/co-ordinate-system.md) 참조
* _MOVE TO FRONT / MOVE TO BACK_ - [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
...
* **Render profile** - [Render profile](fundamentals/render-profile.md) 참조
* **Size** - 선의 길이입니다.
* **Colour** - 선의 색상입니다. [색상 설정 및 HSB](fundamentals/colour-settings-and-hsb.md) 참조
* **x** 및 **y** position - [좌표계](fundamentals/co-ordinate-system.md) 참조
* **rotation** - 선의 각도입니다. 단위는 도입니다.
* **resolution** - [Resolution](fundamentals/resolution.md) 참조
...
* **Render profile** - [Render profile](fundamentals/render-profile.md) 참조
* **radius** - 원의 반지름입니다.
* **Colour** - 원의 색상입니다. [색상 설정 및 HSB](fundamentals/colour-settings-and-hsb.md) 참조
* **x** 및 **y** position - [좌표계](fundamentals/co-ordinate-system.md) 참조
* **resolution** - [Resolution](fundamentals/resolution.md) 참조
* **Fill state** - [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
* _MOVE TO FRONT / MOVE TO BACK_ - [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
...
* **Colour** - 다각형의 색상입니다. [색상 설정 및 HSB](fundamentals/colour-settings-and-hsb.md) 참조
* **x** 및 **y** position - [좌표계](fundamentals/co-ordinate-system.md) 참조
...
* **Use fills as masks** - 채워진 도형을 마스크로 처리합니다. 즉 검은색으로 채워진 것으로 처리됩니다. SVG에 채워진 도형이 있으면 자동으로 설정됩니다. 채워진 도형이 없으면 비활성화됩니다. [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
...
* **Use fills as masks** - 채워진 도형을 마스크로 처리합니다. 즉 검은색으로 채워진 것으로 처리됩니다. SVG 중 하나라도 채워진 도형이 있으면 자동으로 설정됩니다. 채워진 도형이 하나도 없으면 비활성화됩니다. [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
...
* **Fill state** - [채우기, 마스크, 깊이 정렬](fundamentals/fills-masks-and-depth-sorting.md) 참조
* **size** - 텍스트 크기입니다.
* **colour -** [색상 설정 및 HSB](fundamentals/colour-settings-and-hsb.md) 참조
* **x** 및 **y** position - [좌표계](fundamentals/co-ordinate-system.md) 참조
* **rotation** - 이미지가 회전된 각도입니다. 단위는 도입니다.
* **resolution** - [Resolution](fundamentals/resolution.md) 참조
