...
자세한 내용은 [how-liberation-generates-laser-content.md](../../advanced/how-liberation-generates-laser-content.md)를 참고하세요.
{% endhint %}
...
{% hint style="info" %}
Clip editor 안에서는 Creator를 서로 다른 Render Profile에 할당할 수 있지만, 각 레이저는 스캐너 설정에 따라 이러한 프로파일을 처리합니다. [scanner-presets.md](../../advanced/scanner-presets.md)를 참고하세요.
{% endhint %}
