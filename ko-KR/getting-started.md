...
Menu에서는 모든 파일 가져오기/내보내기 옵션과 패널 열기 기능을 찾을 수 있습니다. 이곳에서 라이선스로 컴퓨터를 인증하는 옵션도 사용할 수 있습니다(_Liberation -> Authorise/Deauthorise this computer_).
...
MIDI clock과 Ableton Link를 포함해 여러 동기화 옵션이 있습니다. 음악의 템포를 알고 있다면 화면 슬라이더나 APC40 Tempo 노브로 수동 조정할 수 있습니다. 또한 _Tap Tempo_ 시스템을 사용해 음악에 맞춰 템포를 유지할 수도 있습니다.
...
하나 이상의 Clip을 삭제하려면 Clip Deck 밖으로 드래그하거나(휴지통 아이콘이 표시됨), Clip 오른쪽 클릭 메뉴의 DELETE 버튼을 사용합니다.
