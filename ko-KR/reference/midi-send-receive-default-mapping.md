...
이 시스템은 원래 녹화 및 재생을 위해 설계되었으며, Logic, Ableton 또는 기타 DAW를 사용해 타임라인 애니메이션을 만들 수 있도록 합니다. 라이브 제어에도 사용할 수는 있지만, 해당 용도로 최적화되어 있지는 않으며 APC40 설정과 비교하면 일부 라이브 제어 기능이 빠져 있습니다.
