...
* **Colour** – fargen på punktene. Ignoreres hvis _Inherit Colour_ er aktivert, se nedenfor. _Se også_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – velger gjengivelseskvalitet. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
...
* **Colour** – fargen på trimmepunktene. _Se også_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – velger renderprofilen for punktene. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
