...
* **change render profile for trail** – hvis aktivert, bruker alle trail-kopier valgt **render profile**. _Se_ [Render profile](../fundamentals/render-profile.md "mention").
