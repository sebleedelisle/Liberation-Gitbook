...
Det er veldig effektivt å legge _Zone delay_ til et Clip som allerede kjører. Bruk den relevante kontrollen på APC40 for å justere nivå og mønster. (Se [APC40-referanse](../reference/apc40-reference.md "mention")). Du kan også bruke _Clip Settings_-panelet.
...
Når et Clip har en form for _Zone delay_, ser du et ikon med tre prikker øverst til høyre på Clip. Disse prikkene er animert for å vise hvilken type _Zone delay_ det aktuelle Clip har. Se [Hva er de små ikonene på Clip-knappene?](what-are-the-small-icons-on-the-clip-buttons.md "mention") for mer informasjon.
