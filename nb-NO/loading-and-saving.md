...
* Alt som er beskrevet i [Import/eksport av Laser Settings](loading-and-saving.md#laser-settings-import-export "mention") nedenfor
...
{% hint style="info" %}
Option/Alt - shift - klikk på Clips for å velge dem (eller bruk lassoen). Du ser hvilke Clips som er valgt, på den tykke hvite omrisset rundt dem. Se [Starte / stoppe Clips](clips/starting-stopping-clips.md "mention")
{% endhint %}
...
Eksporter en tidslinjefil med én eller flere tidslinjer. Merk at Clip Deck alltid inkluderes i eksporterte tidslinjefiler (selv om du kan velge hvilke Clips du vil importere tilbake, se [Import av tidslinje](loading-and-saving.md#timeline-import "mention") nedenfor)
