...
Når du har konfigurert laserne i Liberation, kan du tildele hver av dem til en fysisk laserkontroller. (Se [Kompatible lasere og kontrollere (DAC-er)](../hardware/compatible-lasers-and-controllers-dacs.md "mention") for å sjekke hvilken maskinvare du kan bruke.) Kontrollerne er enten koblet til via USB eller over nettverket.
...
* Panelet er delt i to, med en liste over lasere til venstre og listen over tilgjengelige kontrollere til høyre. Hvis du ikke ser laserkontrolleren din i listen, trykker du på _REFRESH_-knappen. Hvis du fortsatt har problemer, se [Feilsøking](../troubleshooting/ "mention").
...
* En oransje firkant 🟧 betyr at kontrolleren har uregelmessige tilkoblingsproblemer. Dette skyldes vanligvis et nettverksproblem, se [Feilsøking](../troubleshooting/ "mention").
* En rød firkant 🟥 betyr at kontrolleren ikke kan nås, se [Feilsøking](../troubleshooting/ "mention").
