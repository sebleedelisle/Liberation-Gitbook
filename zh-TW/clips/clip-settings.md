...
在 Clip 上按右鍵時，會出現一個選單，其中包含該 Clip 的部分選項。關於這個選單前幾個項目的更多資訊，請參閱 [Clip Editor 簡介](../clip-editor/clip-editor-intro.md)、[Clip settings](clip-settings.md) 和 [Clip 群組](groups.md)。

<figure><img src="../.gitbook/assets/Screenshot 2025-01-14 at 11.22.48.png" alt="" width="322"><figcaption><p>Clip settings 右鍵選單</p></figcaption></figure>
...
Clips 可以設定以秒為單位的淡入與淡出時間。預設情況下，fade time 會繼承其 group 設定（可在 group 按鈕上按右鍵變更）。
