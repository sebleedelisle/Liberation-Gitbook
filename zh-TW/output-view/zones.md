...
{% hint style="danger" %}
**警告 - 雷射運作中移動 zone 時請務必格外小心**，並將亮度調到最低。請參閱 [雷射設定流程概覽](../setting-up/setting-up-lasers.md "mention")，了解如何安全地啟用雷射並設定 zones 的完整指南。
{% endhint %}
...
{% hint style="info" %}
小技巧：你可以快速將 zone 設定複製到多台雷射！請參閱 [在雷射之間複製設定](../setting-up/copy-laser-settings.md "mention")
{% endhint %}
