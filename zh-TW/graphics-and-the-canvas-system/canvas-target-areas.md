...
如果你查看 Clip Deck，在 beam zone 按鈕旁邊會看到 Canvas 目標區域按鈕。你可能需要捲動 Output 按鈕才看得到它們；可以使用 `Shift + Left / Right Arrow`、畫面上的 ZONE PAGE 按鈕，或 APC40 按鈕（請參閱 [APC40 參考資料](../reference/apc40-reference.md)）。
