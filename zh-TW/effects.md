...
{% hint style="warning" %}
按下效果按鈕會立刻啟用該效果。不過請注意，如果 level 設為零，就不會有任何變化！請點擊並拖曳按鈕來變更 level，或按右鍵使用 _level_ 滑桿，或使用 APC40 的 fader。
{% endhint %}
...
我會說這是 Liberation 內建最有趣、最有創意的工具之一。試試看，你就會懂我的意思！
{% endhint %}
...
{% hint style="info" %}
你在效果按鈕上看到的小數字，代表該效果的 _level_ 和 _parameter_。_level_ 由 APC40 上的 fader 控制，也可以在按鈕上點擊並拖曳。parameter 則由 APC40 上的旋鈕調整，也可以按右鍵用滑鼠調整。
{% endhint %}
