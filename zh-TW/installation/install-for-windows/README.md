...
適用於 Windows 10 或 11 的 64 位元電腦。如果要執行大型演出，建議使用規格較高的電腦。電腦速度越快，動畫雷射輸出就會越順暢。
...
{% hint style="info" %}
在某些情況下，你可能會看到「Windows protected your PC」警告——Windows 對執行新軟體會比較謹慎！隨著更多人執行並信任 Liberation，這個警告應該會消失。

如果看到這個警告，請按一下 _More info_ 連結，確認 _Publisher_ 顯示為 _SEB.LY LIMITED_，然後按一下 _Run anyway_。
...
安裝程式完成了！按一下 _Finish_ 關閉安裝程式並啟動 Liberation。
