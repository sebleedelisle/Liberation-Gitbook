...
* **Render profile** - 請參閱 [Render profile](fundamentals/render-profile.md)
* **Colour** - 光點的顏色。請參閱[顏色設定與 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 與 **y** position - 請參閱[座標系統](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - 請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - 請參閱 [Render profile](fundamentals/render-profile.md)
* **Size** - 線段的長度
* **Colour** - 線段的顏色。請參閱[顏色設定與 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 與 **y** position - 請參閱[座標系統](fundamentals/co-ordinate-system.md)
* **rotation** - 線段的角度，單位為度
* **resolution** - 請參閱[解析度](fundamentals/resolution.md)
...
* **Render profile** - 請參閱 [Render profile](fundamentals/render-profile.md)
* **radius** - 圓形的半徑
* **Colour** - 圓形的顏色。請參閱[顏色設定與 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 與 **y** position - 請參閱[座標系統](fundamentals/co-ordinate-system.md)
* **resolution** - 請參閱[解析度](fundamentals/resolution.md)
* **Fill state** - 請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - 請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - 請參閱 [Render profile](fundamentals/render-profile.md)
* **size** - 從中心到每個角的距離
* **Colour** - 多邊形的顏色。請參閱[顏色設定與 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 與 **y** position - 請參閱[座標系統](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - 會將任何有填色的圖形處理為 mask，也就是以黑色填滿。如果你的 SVG 有任何填色圖形，此選項會自動啟用；如果沒有任何填色圖形，則會停用。請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - 會將任何有填色的圖形處理為 mask，也就是以黑色填滿。如果你的任何 SVG 有填色圖形，此選項會自動啟用；如果全部都沒有填色圖形，則會停用。請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
...
{% hint style="info" %}
若要在 Liberation 中加入更多字型，請將 .ttf 或 .otf 檔案複製到 data/resources/fonts 資料夾。
{% endhint %}
...
* **Fill state** - 請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
* **size** - 文字大小
* **colour -** 請參閱[顏色設定與 HSB](fundamentals/colour-settings-and-hsb.md)
* **x** 與 **y** position - 請參閱[座標系統](fundamentals/co-ordinate-system.md)
* **rotation** - 影像的旋轉角度，單位為度
* **resolution** - 請參閱[解析度](fundamentals/resolution.md)
...
* **countdown** - 一個（匆忙實作的！）倒數系統。每 2 拍變更一次；如果你想要以秒為單位，請確認速度為 120bpm。
* **countdown start** - 倒數要開始的數字
* _MOVE TO FRONT / MOVE TO BACK_ - 請參閱[填色、masks 與深度排序](fundamentals/fills-masks-and-depth-sorting.md)
