...
Colour calibration patterns 5-8. These can be used alongside the colour correction system within the laser settings. See [Colour calibration](../advanced/colour-calibration.md "mention"). These patterns do not fill the entire output space.
