...
If you want to experiment with scanner behaviour outside a show project, use [Libera Lab](https://github.com/sebleedelisle/libera-lab/releases). It's a desktop tool for Libera-compatible laser controllers, designed for discovering, testing, previewing and inspecting laser output.
