...
For a first-time safe setup walkthrough, follow [Laser setup process overview](setting-up/setting-up-lasers.md).
...
* First power-on checklist: start with test patterns at lowest output, keep shutters closed until ready, bring up one projector at a time, confirm zones/masks before adding more. [Laser setup process overview](setting-up/setting-up-lasers.md).
