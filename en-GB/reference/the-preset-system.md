...
{% hint style="info" %}
If you have a lot of lasers and want to update all of their scanner settings, use the _COPY LASER SETTINGS_ system. See [Copy settings between lasers](../setting-up/copy-laser-settings.md)
{% endhint %}
