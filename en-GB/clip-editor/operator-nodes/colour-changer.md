...
* **hue, saturation, brightness** - the colour values, see [Colour settings and HSB](../fundamentals/colour-settings-and-hsb.md)
* **hue mode** -
...
{% hint style="info" %}
The Colour Change node samples one colour from the gradient for the whole input. If you want the gradient to run across the shape by position, use [Position based changers](position-based-changers.md) instead.
{% endhint %}
