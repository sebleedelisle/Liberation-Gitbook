...
* **Colour** – the colour of the dots. Ignored if _Inherit Colour_ is enabled, see below. _See also_ [Colour settings and HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Colour** – the colour of the trim dots. _See also_ [Colour settings and HSB](../fundamentals/colour-settings-and-hsb.md "mention")
