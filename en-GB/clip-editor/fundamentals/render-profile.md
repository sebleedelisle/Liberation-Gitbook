...
For more details see [◼️ How Liberation generates laser content](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
{% hint style="info" %}
Within the clip editor, you can assign creators to different render profiles, but each laser will process these profiles dependent on their scanner settings. See [◼️ Scanner presets & render profiles](../../advanced/scanner-presets.md)
{% endhint %}
