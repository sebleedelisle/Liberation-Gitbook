...
* **Colour** - the colour of the dot. See [Colour settings and HSB](fundamentals/colour-settings-and-hsb.md)
...
* **Colour** - the colour of the line. See [Colour settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
...
* **Colour** - the colour of the circle. See [Colour settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* **resolution** - see [Resolution](fundamentals/resolution.md)
...
* **Colour** - the colour of the polygon. See [Colour settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
...
* **colour -** see [Colour settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* **rotation** - the rotated angle of the image, in degrees
* **resolution** - see [Resolution](fundamentals/resolution.md)
