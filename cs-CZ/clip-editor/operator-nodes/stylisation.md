...
* **change render profile for trail** – pokud je zapnuto, všechny kopie trailu použijí vybraný **render profile**. _Viz_ [Render profile](../fundamentals/render-profile.md).
