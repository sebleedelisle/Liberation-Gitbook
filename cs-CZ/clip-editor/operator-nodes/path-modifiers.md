...
* **Colour** – barva teček. Ignoruje se, pokud je zapnuté _Inherit Colour_, viz níže. _Viz také_ [Nastavení barev a HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – vybírá kvalitu vykreslování. _Viz_ [Render Profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – barva teček v bodech ořezu. _Viz také_ [Nastavení barev a HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – vybírá Render Profile pro tečky. _Viz_ [Render Profile](../fundamentals/render-profile.md "mention")
