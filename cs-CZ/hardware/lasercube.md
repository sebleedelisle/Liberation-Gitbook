...
Připojte LaserCube k počítači pomocí micro USB kabelu a potom jej vyhledejte v panelu _Controller Assignment_ (viz [Přiřazení kontroleru](../setting-up/controller-assignment.md "mention")). Pokud se nezobrazí automaticky, klikněte na tlačítko _REFRESH_.
...
Přepněte LaserCube do režimu „LAN Client“ a ujistěte se, že je v síti router. LaserCube získá IP adresu z routeru a poté by se měl zobrazit v panelu _Controller Assignment_ (viz [Přiřazení kontroleru](../setting-up/controller-assignment.md "mention")).
