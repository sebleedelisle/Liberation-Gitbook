...
Chcete-li synchronizovat pomocí Ableton Link, zvolte jako zdroj tempa _ABLETON LINK_. Liberation se připojí k relaci Link ve vaší místní síti a řídí se sdíleným tempem a fází doby z ostatních aplikací podporujících Link.

Ableton Link nepoužívá MIDI port a nepřenáší absolutní pozici ve skladbě. Pokud potřebujete, aby začátek taktu v Liberation odpovídal konkrétnímu okamžiku v show, použijte ovládací prvky pro reset taktu.
