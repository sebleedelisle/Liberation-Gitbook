...
Pomocí této volby vyberete předem připravené nastavení skenerů. Výchozí volba je obvykle v pořádku, takže toto nastavení byste neměli potřebovat měnit, pokud nemáte výrazně horší (nebo lepší) skenery. Pokud chcete jít více do hloubky, podívejte se na [◼️ Předvolby skenerů a profily vykreslování](../../advanced/scanner-presets.md "mention")
...
S těmito nastaveními byste neměli potřebovat manipulovat, ale pokud vás zajímají podrobnosti, podívejte se na [◼️ Pokročilá nastavení laseru](../../advanced/advanced-laser-settings.md "mention")
