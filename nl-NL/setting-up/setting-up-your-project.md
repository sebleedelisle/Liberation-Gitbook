...
3.  **Pas de zones aan:**\
    In de _OUTPUT_-weergave kun je de zones controleren. Ga met Tab door elke laser of klik op een van de genummerde knoppen bovenaan de weergave. Pas elke zone naar wens aan, of voeg zelfs nieuwe zones toe. Zie [Output-weergave](../output-view/ "mention").
...
5.  **Maak verbinding met je controllers:** wanneer je klaar bent om je lasers aan te sluiten en te beginnen, open je het paneel _Controller Assignment_. Zie [Controllertoewijzing](controller-assignment.md "mention").
