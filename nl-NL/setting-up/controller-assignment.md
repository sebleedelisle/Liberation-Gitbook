...
* Het paneel is in twee delen verdeeld: links staat een lijst met lasers en rechts de lijst met beschikbare controllers. Als je je lasercontroller niet in de lijst ziet, druk dan op de knop _REFRESH_. Als je problemen blijft houden, zie [troubleshooting](../troubleshooting/ "mention").
...
* Een oranje vierkant 🟧 betekent dat de controller af en toe verbindingsproblemen heeft. Dit wordt meestal veroorzaakt door een netwerkprobleem; zie [troubleshooting](../troubleshooting/ "mention").
* Een rood vierkant 🟥 betekent dat de controller niet bereikbaar is; zie [troubleshooting](../troubleshooting/ "mention").
