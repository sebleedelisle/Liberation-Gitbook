...
{% hint style="info" %}
Je kunt ook een canvas zone aan een laser toewijzen door in de _OUTPUT_-weergave op de knop _add canvas zone_ te klikken. Zie [Zones](../output-view/zones.md).
{% endhint %}
