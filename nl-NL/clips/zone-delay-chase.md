...
Wanneer een Clip een vorm van _Zone delay_ heeft, zie je rechtsboven in de Clip een pictogram met drie puntjes. Deze puntjes zijn geanimeerd om de stijl van _Zone delay_ voor die Clip te tonen. Zie [Wat betekenen de kleine pictogrammen op de Clip-knoppen?](what-are-the-small-icons-on-the-clip-buttons.md "mention") voor meer informatie.
