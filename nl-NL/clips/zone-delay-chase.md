...
Het is erg effectief om zone delay toe te voegen aan een Clip die al loopt. Gebruik de bijbehorende bediening op de APC40 om het niveau en het patroon aan te passen. (Zie [APC40-referentie](../reference/apc40-reference.md)). Je kunt ook het paneel _Clip Settings_ gebruiken.
...
Wanneer een Clip een vorm van _Zone delay_ heeft, zie je rechtsboven in de Clip een pictogram met drie puntjes. Deze puntjes zijn geanimeerd om de stijl van _Zone delay_ voor die Clip te tonen. Zie [Wat betekenen de kleine pictogrammen op de Clip-knoppen?](what-are-the-small-icons-on-the-clip-buttons.md) voor meer informatie.
