...
Zie voor meer informatie [◼️ Hoe Liberation lasercontent genereert](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
{% hint style="info" %}
In de Clip Editor kun je Creators aan verschillende render profiles toewijzen, maar elke laser verwerkt deze profielen afhankelijk van de scanner settings. Zie [◼️ Scannerpresets & renderprofielen](../../advanced/scanner-presets.md)
{% endhint %}
