...
* **Render profile** - zie [Render Profile](fundamentals/render-profile.md)
* **Colour** - de kleur van het punt. Zie [Kleurinstellingen en HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- en **y**-positie - zie [Coördinatensysteem](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - zie [Vullingen, maskers en dieptesortering](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - de kleur van de lijn. Zie [Kleurinstellingen en HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- en **y**-positie - zie [Coördinatensysteem](fundamentals/co-ordinate-system.md)
* **rotation** - de hoek van de lijn, in graden
* **resolution** - zie [Resolutie](fundamentals/resolution.md)
...
* **Colour** - de kleur van de cirkel. Zie [Kleurinstellingen en HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- en **y**-positie - zie [Coördinatensysteem](fundamentals/co-ordinate-system.md)
* **resolution** - zie [Resolutie](fundamentals/resolution.md)
* **Fill state** - zie [Vullingen, maskers en dieptesortering](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - zie [Vullingen, maskers en dieptesortering](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - de kleur van de veelhoek. Zie [Kleurinstellingen en HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- en **y**-positie - zie [Coördinatensysteem](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - verwerkt elke gevulde vorm als een mask, oftewel gevuld met zwart. Dit wordt automatisch ingesteld als je SVG gevulde vormen bevat. Als er geen gevulde vormen zijn, wordt dit uitgeschakeld. Zie [Vullingen, maskers en dieptesortering](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** zie [Kleurinstellingen en HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- en **y**-positie - zie [Coördinatensysteem](fundamentals/co-ordinate-system.md)
* **rotation** - de rotatiehoek van de afbeelding, in graden
* **resolution** - zie [Resolutie](fundamentals/resolution.md)
