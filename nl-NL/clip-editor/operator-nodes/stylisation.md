...
* **change render profile for trail** – indien ingeschakeld gebruiken alle trail-kopieën het geselecteerde **render profile**. _Zie_ [Render profile](../fundamentals/render-profile.md).
