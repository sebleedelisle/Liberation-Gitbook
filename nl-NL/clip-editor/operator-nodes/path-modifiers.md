...
* **Colour** – de kleur van de dots. Wordt genegeerd als _Inherit Colour_ is ingeschakeld; zie hieronder. _Zie ook_ [Kleurinstellingen en HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – kiest de renderkwaliteit. _Zie_ [Render Profile](../fundamentals/render-profile.md)
...
* **Colour** – de kleur van de trim-dots. _Zie ook_ [Kleurinstellingen en HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – kiest het renderprofiel voor de dots. _Zie_ [Render Profile](../fundamentals/render-profile.md)
