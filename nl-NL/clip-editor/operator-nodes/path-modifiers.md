...
* **Colour** – de kleur van de dots. Wordt genegeerd als _Inherit Colour_ is ingeschakeld; zie hieronder. _Zie ook_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – kiest de renderkwaliteit. _Zie_ [render-profile.md](../fundamentals/render-profile.md "mention")
...
* **Colour** – de kleur van de trim-dots. _Zie ook_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – kiest het renderprofiel voor de dots. _Zie_ [render-profile.md](../fundamentals/render-profile.md "mention")
