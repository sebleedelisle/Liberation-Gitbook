...
#### **Draait Liberation op Windows?**

Ja - Liberation ondersteunt **Windows 10 en 11 (64-bit)** volledig, met precies dezelfde functies als de Mac-versie. Elke release verschijnt gelijktijdig voor beide platforms.

#### **Draait Liberation op Mac**

Ja - Liberation ondersteunt **Mac (macOS 12 Monterey en later)** volledig, met dezelfde functies als de Windows-versie. Alle updates worden tegelijk uitgebracht.

#### **Wat zijn de minimale systeemeisen?**

Dat hangt af van hoeveel lasers je wilt aansturen. Als je maar een paar lasers gebruikt, is een machine met lage specificaties prima. Elke Apple Silicon Mac draait heel goed en zou tot 100 lasers moeten kunnen aansturen. Als je complexe shows draait waarbij veel op het spel staat, raden we de beste machine aan die je je kunt veroorloven.

#### **Hoeveel lasers kan ik met Liberation aansturen?**

Liberation kan veel lasers op één computer aansturen. Het is getest met meer dan 100 lasercontrollers, dus het antwoord hangt af van:
...
We werken momenteel aan een configureerbaar MIDI-systeem dat dit in de toekomst mogelijk maakt. Tot die tijd hebben sommige gebruikers succes gehad met een MIDI-interpreter die willekeurige MIDI-berichten kan omzetten voor het MIDI Send/Receive-systeem, maar dit is een omslachtig en geavanceerd proces. Zoek op het [forum](https://forum.liberationlaser.com) naar advies over deze setup, maar realistisch gezien is de APC40 de beste optie.
...
* [Mercury by X-Laser](https://x-laser.com/pages/mercury-laser-control-system) (mogelijk moet je je firmware updaten)
...
Om betere interoperabiliteit tussen software en hardware te stimuleren, ondersteunt Liberation alleen DACs met een gepubliceerd communicatieprotocol. Ik denk dat dit de beste weg vooruit is voor de laserindustrie.
...
Zie de [shop](https://liberationlaser.com/shop)-pagina voor de huidige prijzen.

#### **Wat zijn de beperkingen tussen de licentieniveaus?**
...
* Zorg dat je verbonden bent met internet en klik op de knop _De-authorise this computer_ op het _About_-scherm
...
Ja. `Cmd / Ctrl`-klik op de slider en je kunt de waarde met het toetsenbord invoeren.
