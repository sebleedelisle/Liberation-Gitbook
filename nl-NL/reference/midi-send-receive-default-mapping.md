...
Let op: dit systeem is oorspronkelijk ontworpen voor opnemen en afspelen, zodat je Logic, Ableton of een andere DAW kunt gebruiken om tijdlijnanimaties te maken. Je kunt het wel gebruiken voor live-besturing, maar het is daar niet voor geoptimaliseerd. Bovendien ontbreken sommige functies voor live-besturing in vergelijking met de APC40-setup.
