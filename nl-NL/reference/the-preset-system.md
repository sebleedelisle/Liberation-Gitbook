...
{% hint style="info" %}
Als je veel lasers hebt en de scanner-instellingen van allemaal wilt bijwerken, gebruik dan het _COPY LASER SETTINGS_-systeem. Zie [Instellingen kopiëren tussen lasers](../setting-up/copy-laser-settings.md)
{% endhint %}
