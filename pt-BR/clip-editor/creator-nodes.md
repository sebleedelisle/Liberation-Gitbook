...
* **Render profile** - consulte [Perfil de renderização](fundamentals/render-profile.md)
...
* _MOVE TO FRONT / MOVE TO BACK_ - consulte [Preenchimentos, masks e ordenação por profundidade](fundamentals/fills-masks-and-depth-sorting.md)
...
* posição **x** e **y** - consulte [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
* **resolution** - consulte [Resolução](fundamentals/resolution.md)
* **Fill state** - consulte [Preenchimentos, masks e ordenação por profundidade](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - consulte [Preenchimentos, masks e ordenação por profundidade](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - processa qualquer forma preenchida como uma mask, ou seja, preenchida com preto. Isso será definido automaticamente se o SVG tiver alguma forma preenchida. Se ele não tiver formas preenchidas, a opção será desativada. Consulte [Preenchimentos, masks e ordenação por profundidade](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - processa qualquer forma preenchida como uma mask, ou seja, preenchida com preto. Isso será definido automaticamente se qualquer um dos seus SVGs tiver formas preenchidas. Se nenhum tiver formas preenchidas, a opção será desativada. Consulte [Preenchimentos, masks e ordenação por profundidade](fundamentals/fills-masks-and-depth-sorting.md)
