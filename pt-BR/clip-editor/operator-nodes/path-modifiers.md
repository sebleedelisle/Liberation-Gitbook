...
* **Colour** – a cor dos pontos. Ignorado se _Inherit Colour_ estiver ativado; veja abaixo. _Veja também_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – escolhe a qualidade de renderização. _Veja_ [render-profile.md](../fundamentals/render-profile.md)
...
* **Colour** – a cor dos pontos de corte. _Veja também_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – escolhe o render profile dos pontos. _Veja_ [render-profile.md](../fundamentals/render-profile.md)
