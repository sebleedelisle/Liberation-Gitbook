...
* **Render Profile** – escolhe a qualidade de renderização. _Veja_ [Perfil de renderização](../fundamentals/render-profile.md)
...
* **Render Profile** – escolhe o perfil de renderização dos pontos. _Veja_ [Perfil de renderização](../fundamentals/render-profile.md)
