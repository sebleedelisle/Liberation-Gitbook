...
* **Colour** – a cor dos pontos. Ignorado se _Inherit Colour_ estiver ativado; veja abaixo. _Veja também_ [Configurações de cor e HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – escolhe a qualidade de renderização. _Veja_ [Render Profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – a cor dos pontos de corte. _Veja também_ [Configurações de cor e HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – escolhe o render profile dos pontos. _Veja_ [Render Profile](../fundamentals/render-profile.md "mention")
