...
# ✅ Parada de emergência / intertravamentos
...
É por isso que lasers têm sistemas integrados de intertravamento e parada remota, que desarmam e armam o laser de forma controlada.
{% endhint %}

**Sempre use botões de parada remota**, mesmo ao usar seus lasers em espaços privados e controlados. Você nunca sabe quando alguém pode entrar por acaso no caminho do laser, ou quando pode surgir um feixe forte inesperado que começa a queimar o acabamento de gesso (pergunte como eu sei).
