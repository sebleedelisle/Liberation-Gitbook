...
Conecte seu LaserCube ao computador com um cabo micro USB e procure por ele no painel _Controller Assignment_ (veja [Atribuição de controladores](../setting-up/controller-assignment.md "mention")). Se ele não aparecer automaticamente, pressione o botão _REFRESH_.
...
Coloque seu LaserCube no modo "LAN Client" e verifique se há um roteador na rede. O LaserCube receberá um endereço IP do roteador e então deverá aparecer no painel _Controller Assignment_. (Veja [Atribuição de controladores](../setting-up/controller-assignment.md "mention")).
