...
É muito eficaz aplicar zone delay a um clip que já está em execução, usando o controle correspondente no APC40 para ajustar o nível e o padrão. (Veja [apc40-reference.md](../reference/apc40-reference.md)). Ou você pode usar o painel _Clip Settings_.
