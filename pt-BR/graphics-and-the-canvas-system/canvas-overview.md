...
{% hint style="info" %}
Você também pode atribuir uma zone do Canvas a um laser clicando no botão _add canvas zone_ na visualização _OUTPUT_. Consulte [Zonas](../output-view/zones.md "mention").
{% endhint %}
