...
Se você olhar no Clip Deck, ao lado dos botões de beam zone, verá os botões das Canvas target areas. Talvez seja necessário rolar os botões de Output para vê-los; use `Shift + Left / Right Arrow`, os botões ZONE PAGE na tela ou os botões do APC40 (veja [Referência do APC40](../reference/apc40-reference.md)).
