...
* O painel é dividido em duas partes: uma lista de lasers à esquerda e a lista de controladores disponíveis à direita. Se você não vir seu controlador de laser na lista, pressione o botão _REFRESH_. Se continuar tendo problemas, consulte [solução de problemas](../troubleshooting/ "mention").
...
* Um quadrado laranja 🟧 significa que o controlador está com problemas intermitentes de conexão. Isso geralmente é causado por um problema de rede; consulte [solução de problemas](../troubleshooting/ "mention").
* Um quadrado vermelho 🟥 significa que o controlador não pode ser acessado; consulte [solução de problemas](../troubleshooting/ "mention").
