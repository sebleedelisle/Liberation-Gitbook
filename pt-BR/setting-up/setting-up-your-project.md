...
3.  **Ajuste as zonas:**\
    Na visualização _OUTPUT_, você pode verificar as zonas. Use Tab para alternar entre cada laser ou clique em um dos botões numerados na parte superior da visualização. Ajuste cada zona conforme necessário ou adicione novas zonas. Veja [Visualização Output](../output-view/ "mention").
...
Acione cada Clip clicando no respectivo botão e, em seguida, ative ou desative as zones e a inversão de X e Y usando os botões na tela. Veja [Clips e Clip Deck](../clips/ "mention").

    \\

    <figure><img src="../.gitbook/assets/Y.png" alt=""><figcaption></figcaption></figure>
5.  **Conecte aos seus controllers:** quando você estiver pronto para conectar seus lasers e começar, abra o painel _Controller Assignment_. Veja [Atribuição de controladores](controller-assignment.md "mention").
