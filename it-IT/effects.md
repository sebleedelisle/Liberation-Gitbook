...
Qualsiasi cosa tu possa fare nel Clip Editor può essere usata come effetto. Infatti, gli effetti si modificano con lo stesso identico editor di nodes usato per i Clips! Vedi [Modificare gli effetti](effects.md#editing-effects). Le possibilità creative sono praticamente infinite.
...
Aggiungi un parametro al tuo effetto con un _Parameter node._ Il sistema Parameter permette di regolare dall’esterno più impostazioni all’interno dell’effetto. Vedi [Controllo Parameter](clip-editor/oscillators/parameter-control.md) per maggiori informazioni.
