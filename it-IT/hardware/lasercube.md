...
Collega il LaserCube al computer con un cavo micro USB, poi cercalo nel pannello _Controller Assignment_ (vedi [controller-assignment.md](../setting-up/controller-assignment.md)). Se non compare automaticamente, premi il pulsante _REFRESH_.
...
Metti il LaserCube in modalità "LAN Client" e assicurati che ci sia un router sulla rete. Il LaserCube riceverà un indirizzo IP dal router e dovrebbe quindi comparire nel pannello _Controller Assignment_. (Vedi [controller-assignment.md](../setting-up/controller-assignment.md)).
