...
Il tipo principale di zone che userai nella maggior parte dei progetti è la _Beam zone_. È una zone pensata per effetti beam atmosferici nell’aria. L’altro tipo di zone è una _Canvas zone_ (vedi [Grafica e sistema Canvas](../graphics-and-the-canvas-system/)).
...
Fai clic sul pulsante _Add a new beam zone_ nella parte superiore della toolbar e apparirà una nuova zone. Nota che le beam zone vengono ordinate in base all’ordine in cui le aggiungi, ma puoi riordinarle. Vedi [Riordinare le beam zone](re-ordering-beam-zones.md)
...
* Eliminarla
* Aggiungi una _Alt Zone_ (vedi [Sistema Alt zone](alt-zone-system.md))
