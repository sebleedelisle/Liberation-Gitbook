...
È raro, ma a volte Liberation potrebbe non avviarsi o chiudersi subito dopo l’apertura. Quasi sempre succede perché uno dei file di configurazione locali si è danneggiato, di solito dopo un arresto anomalo del sistema o un evento imprevisto sul computer.

Per fortuna, si risolve facilmente reimpostando le impostazioni locali. Ecco come farlo su macOS e Windows.
...
1. Nel Finder, premi **Shift + Cmd + G**.
...
Dentro la cartella della tua versione, apri:
...
Salva una copia di backup di questo file in un posto sicuro, per esempio sul Desktop, quindi eliminalo dalla cartella di lavoro di Liberation.

Prova ad avviare di nuovo Liberation. Se ora si apre normalmente, invia via email il file di backup a [**info@liberationlaser.com**](mailto:info@liberationlaser.com) così possiamo analizzare cosa ha causato il problema.

***

#### Passaggio 3 - Esegui un backup, poi elimina l’intera cartella di lavoro
...
Questo ci aiuta a capire cosa ha causato il problema, così possiamo evitarlo nelle versioni future.

Comprimi in formato zip il **backup** del Passaggio 3, se non l’hai già fatto, quindi invialo via email per permetterci di diagnosticare la causa.
...
* Disattiva temporaneamente antivirus o strumenti di sicurezza che potrebbero bloccare la creazione di nuove cartelle, quindi prova ad avviare di nuovo.
* Reinstalla l’ultima build di Liberation sopra l’installazione esistente.
* Se nessuna delle soluzioni precedenti funziona, contatta il supporto a [**info@liberationlaser.com**](mailto:info@liberationlaser.com) con i dettagli e gli eventuali crash log presenti nella sottocartella `logs`, se disponibile.
