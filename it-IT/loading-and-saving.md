...
* Tutto ciò che è descritto in [Importazione/esportazione delle Laser Settings](loading-and-saving.md#laser-settings-import-export "mention") più sotto
...
Esporta un file timeline con una o più timeline. Nota che il Clip Deck è sempre incluso nei file timeline esportati (anche se puoi scegliere in modo selettivo quali Clip reimportare; vedi [Importazione della timeline](loading-and-saving.md#timeline-import "mention") più sotto).
