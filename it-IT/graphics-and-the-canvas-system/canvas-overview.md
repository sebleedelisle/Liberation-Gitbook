...
{% hint style="info" %}
Puoi anche assegnare una zona Canvas a un laser facendo clic sul pulsante _add canvas zone_ nella vista _OUTPUT_. Vedi [Zone](../output-view/zones.md "mention").
{% endhint %}
