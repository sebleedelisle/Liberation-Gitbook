...
* **Render Profile** – sceglie la qualità di rendering. _Vedi_ [Render profile](../fundamentals/render-profile.md)
...
* **Render Profile** – sceglie il render profile per i punti. _Vedi_ [Render profile](../fundamentals/render-profile.md)
