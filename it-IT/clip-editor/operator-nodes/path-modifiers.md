...
* **Colour** – il colore dei punti. Viene ignorato se _Inherit Colour_ è abilitato, vedi sotto. _Vedi anche_ [Impostazioni colore e HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – sceglie la qualità di rendering. _Vedi_ [Profilo di rendering](../fundamentals/render-profile.md)
...
* **Colour** – il colore dei punti di ritaglio. _Vedi anche_ [Impostazioni colore e HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – sceglie il profilo di rendering per i punti. _Vedi_ [Profilo di rendering](../fundamentals/render-profile.md)
