...
* **Colour** – il colore dei punti. Viene ignorato se _Inherit Colour_ è abilitato, vedi sotto. _Vedi anche_ [Impostazioni colore e HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – sceglie la qualità di rendering. _Vedi_ [Render profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – il colore dei punti di ritaglio. _Vedi anche_ [Impostazioni colore e HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – sceglie il render profile per i punti. _Vedi_ [Render profile](../fundamentals/render-profile.md "mention")
