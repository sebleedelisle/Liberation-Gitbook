...
Per maggiori dettagli, vedi [◼️ Come Liberation genera contenuti laser](../../advanced/how-liberation-generates-laser-content.md "mention")
{% endhint %}
...
{% hint style="info" %}
Nel Clip Editor puoi assegnare i Creator a diversi render profile, ma ogni laser elaborerà questi profili in base alle proprie impostazioni dello scanner. Vedi [◼️ Preset scanner e render profile](../../advanced/scanner-presets.md "mention")
{% endhint %}
