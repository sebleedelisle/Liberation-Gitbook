...
* **Render profile** - vedi [render-profile.md](fundamentals/render-profile.md)
* **Colour** - il colore del punto. Vedi [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* **x** e **y** position - vedi [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - vedi [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - il colore della linea. Vedi [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* **x** e **y** position - vedi [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **rotation** - l’angolo della linea, in gradi
* **resolution** - vedi [resolution.md](fundamentals/resolution.md)
...
* **Colour** - il colore del cerchio. Vedi [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* **x** e **y** position - vedi [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **resolution** - vedi [resolution.md](fundamentals/resolution.md)
* **Fill state** - vedi [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - vedi [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - il colore del poligono. Vedi [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* **x** e **y** position - vedi [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - elabora qualsiasi forma riempita come maschera, cioè riempita di nero. Viene impostato automaticamente se il tuo SVG contiene forme riempite. Se non contiene forme riempite, viene disabilitato. Vedi [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - elabora qualsiasi forma riempita come maschera, cioè riempita di nero. Viene impostato automaticamente se uno qualsiasi dei tuoi SVG contiene forme riempite. Se nessuno contiene forme riempite, viene disabilitato. Vedi [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** vedi [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* **x** e **y** position - vedi [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **rotation** - l’angolo di rotazione dell’immagine, in gradi
* **resolution** - vedi [resolution.md](fundamentals/resolution.md)
