...
{% hint style="info" %}
Se non vedi alcun output nel 3D visualiser, potresti dover usare i pulsanti delle zone per attivare le zone desiderate. Devi anche assicurarti che _Preview to lasers_ sia abilitato; vedi [pannello Clip Editor](clip-editor-intro.md#clip-editor-panel) qui sotto.
{% endhint %}

### Creare una clip

Di solito inizi con uno o più [nodi Creator](creator-nodes.md) e colleghi i [nodi Operator](operator-nodes/) da sinistra a destra per elaborare il contenuto. Quando avvicini tra loro Creator e/o Operator, noterai che si collegano automaticamente. Puoi trascinarli di nuovo lontano l’uno dall’altro per scollegarli.
...
Gli oscillatori hanno sempre impostazioni di _range_ che controllano il valore minimo e massimo della proprietà da modificare. Inoltre, i _Wave Oscillators_ hanno sempre un’impostazione _duration_ che determina la velocità con cui l’oscillatore modifica il valore. Vedi [Oscillatori a onda](oscillators/wave-oscillators.md) per maggiori informazioni.
