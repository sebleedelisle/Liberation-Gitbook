...
{% hint style="info" %}
Questa impostazione di velocità non modifica il point rate; regola invece quanto sono distanziati i punti tra loro. Per maggiori informazioni, vedi [how-liberation-generates-laser-content.md](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
Usa questa impostazione per scegliere una configurazione scanner predefinita. L’opzione di default di solito va bene, quindi non dovresti aver bisogno di cambiarla, a meno che tu non abbia scanner particolarmente scadenti (o particolarmente buoni). Se vuoi approfondire, vedi [scanner-presets.md](../../advanced/scanner-presets.md)

#### Colour calibration

Puoi usare questo sistema per correggere la curva di luminosità e il bilanciamento del bianco del laser. Vedi [colour-calibration.md](../../advanced/colour-calibration.md)
