...
Dopo aver configurato i laser in Liberation, puoi assegnare ciascuno di essi a un controller laser nel mondo reale. Consulta [compatible-lasers-and-controllers-dacs.md](../hardware/compatible-lasers-and-controllers-dacs.md) per verificare quale hardware puoi usare. I controller saranno collegati tramite USB oppure tramite rete.
...
* Il pannello è diviso in due: a sinistra trovi l’elenco dei laser, a destra l’elenco dei controller disponibili. Se non vedi il tuo controller laser nell’elenco, premi il pulsante _REFRESH_. Se continui ad avere problemi, consulta [troubleshooting](../troubleshooting/).
...
* Un quadrato arancione 🟧 indica che il controller ha problemi di connessione intermittenti. Di solito dipende da un problema di rete; consulta [troubleshooting](../troubleshooting/).
* Un quadrato rosso 🟥 indica che il controller non è raggiungibile; consulta [troubleshooting](../troubleshooting/).
