...
A Zone delay rendszer egyszerű, mégis hatékony módszer arra, hogy változatosságot vigyél a zónák közé, és igazán kihasználd a több lézeres összeállítást. Hagyományosabb chase effekt létrehozására is használható.
