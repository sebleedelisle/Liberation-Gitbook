...
* a kívánt lézer számának billentyűjével (_1-9 keys_)
...
Több szinkronizálási lehetőség is elérhető, például MIDI clock és Ableton Link. Ha ismered a zene tempóját, manuálisan is beállíthatod a képernyőn lévő csúszkával vagy az APC40 Tempo knob vezérlőjével, de a _Tap Tempo_ rendszerrel a zenéhez is igazíthatod.
