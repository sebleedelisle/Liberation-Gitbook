...
Az alapértelmezett beállítás 8, vízszintesen elrendezett lézert tartalmaz, de ezt tetszés szerint módosíthatod. Amíg ismerkedsz a szoftverrel, valószínűleg érdemes megtartani ezt az alapbeállítást, később pedig hozzáigazíthatod a saját hardveres összeállításodhoz. (Lásd: [setting-up-your-project.md](setting-up/setting-up-your-project.md))

{% hint style="warning" %}
Fontos: Mielőtt bármilyen lézert élesítenél, győződj meg róla, hogy érted a kapcsolódó kockázatokat, és alaposan olvasd végig a [setting-up-lasers.md](setting-up/setting-up-lasers.md) fejezetet.
{% endhint %}
...
A 3D nézet megmutatja, hogyan fognak kinézni a lézereid, és beállítható úgy, hogy a saját lézeres összeállításodnak feleljen meg. Kattints és húzd az egeret a kamera forgatásához, az egérgörgővel pedig előre-hátra mozgathatod a nézetet. Sok további opciót találsz a _3D Visualiser settings_ panelen (_View -> 3D Visualiser Settings_). Lásd: [3d-visualiser.md](setting-up/3d-visualiser.md).
...
További részletekért lásd: [output-view](output-view/).

#### Canvas

A Canvas rendszert főként grafikákhoz és építészeti mappinghez használják. Összetett képeket oszthatsz szét több lézer között, és minden szakaszt perspektívahelyesen korrigálhatsz. Lásd: [graphics-and-the-canvas-system](graphics-and-the-canvas-system/).
...
A tájékozódást a felül látható, kisméretű Clip Deck-vizualizáció segíti. Lásd még: [clips](clips/)
...
Jobb kattintással további beállításokat szerkeszthetsz a cliphez. Lásd még: [clip-settings.md](clips/clip-settings.md)
...
_\*Az 1–8 forgóvezérlő az APC40 Mk2 tetején, az Mk1-en pedig jobb felül található. Lásd még:_ [apc40-reference.md](reference/apc40-reference.md)
...
{% hint style="danger" %}
Mielőtt bármilyen lézert élesítenél, mindenképpen menj végig a [setting-up-lasers.md](setting-up/setting-up-lasers.md) fejezeten.
{% endhint %}
