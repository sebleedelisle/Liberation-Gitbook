...
Ha tehát finomhangolod a scannerbeállításokat az új CT6210 scannereidhez, elmentheted presetként, például "CT6210" néven. Ezután bármikor elérhető lesz a preset listában, amikor később szükséged van rá, és megjelenik a legördülő menüben.
...
{% hint style="info" %}
Ha sok lézered van, és mindegyik scanner settings értékét frissíteni szeretnéd, használd a _COPY LASER SETTINGS_ rendszert. Lásd: [Beállítások másolása lézerek között](../setting-up/copy-laser-settings.md "mention")
{% endhint %}
