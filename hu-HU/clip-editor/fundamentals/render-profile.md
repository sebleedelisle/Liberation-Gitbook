...
További részletekért lásd: [◼️ Hogyan generál a Liberation lézeres tartalmat](../../advanced/how-liberation-generates-laser-content.md "mention")
{% endhint %}
...
{% hint style="info" %}
A Clip Editor felületén a Creator elemeket különböző renderprofilokhoz rendelheted, de az egyes lézerek ezeket a profilokat a saját scanner beállításaik alapján dolgozzák fel. Lásd: [◼️ Scanner presetek és renderprofilok](../../advanced/scanner-presets.md "mention")
{% endhint %}
