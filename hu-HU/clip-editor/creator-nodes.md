...
* **Render profile** - lásd: [Render profile](fundamentals/render-profile.md)
* **Colour** - a pont színe. Lásd: [Színbeállítások és HSB](fundamentals/colour-settings-and-hsb.md)
* **x** és **y** pozíció - lásd: [Koordináta-rendszer](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - lásd: [Kitöltések, maszkok és mélységi rendezés](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - lásd: [Render profile](fundamentals/render-profile.md)
* **Size** - a vonal hossza
* **Colour** - a vonal színe. Lásd: [Színbeállítások és HSB](fundamentals/colour-settings-and-hsb.md)
* **x** és **y** pozíció - lásd: [Koordináta-rendszer](fundamentals/co-ordinate-system.md)
* **rotation** - a vonal szöge fokban
* **resolution** - lásd: [Felbontás](fundamentals/resolution.md)
...
* **Render profile** - lásd: [Render profile](fundamentals/render-profile.md)
* **radius** - a kör sugara
* **Colour** - a kör színe. Lásd: [Színbeállítások és HSB](fundamentals/colour-settings-and-hsb.md)
* **x** és **y** pozíció - lásd: [Koordináta-rendszer](fundamentals/co-ordinate-system.md)
* **resolution** - lásd: [Felbontás](fundamentals/resolution.md)
* **Fill state** - lásd: [Kitöltések, maszkok és mélységi rendezés](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - lásd: [Kitöltések, maszkok és mélységi rendezés](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - a sokszög színe. Lásd: [Színbeállítások és HSB](fundamentals/colour-settings-and-hsb.md)
* **x** és **y** pozíció - lásd: [Koordináta-rendszer](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - minden kitöltött alakzatot maszkként dolgoz fel, azaz feketével kitöltve. Ez automatikusan be lesz kapcsolva, ha az SVG-ben vannak kitöltött alakzatok. Ha nincsenek benne kitöltött alakzatok, ki lesz kapcsolva. Lásd: [Kitöltések, maszkok és mélységi rendezés](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - minden kitöltött alakzatot maszkként dolgoz fel, azaz feketével kitöltve. Ez automatikusan be lesz kapcsolva, ha bármelyik SVG-ben vannak kitöltött alakzatok. Ha egyikben sincsenek kitöltött alakzatok, ki lesz kapcsolva. Lásd: [Kitöltések, maszkok és mélységi rendezés](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** lásd: [Színbeállítások és HSB](fundamentals/colour-settings-and-hsb.md)
* **x** és **y** pozíció - lásd: [Koordináta-rendszer](fundamentals/co-ordinate-system.md)
* **rotation** - a kép elforgatási szöge fokban
* **resolution** - lásd: [Felbontás](fundamentals/resolution.md)
