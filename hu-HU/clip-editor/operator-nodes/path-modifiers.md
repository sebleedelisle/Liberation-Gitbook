...
* **Colour** – a pontok színe. A rendszer figyelmen kívül hagyja, ha az _Inherit Colour_ be van kapcsolva, lásd lent. _Lásd még_ [Színbeállítások és HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – a renderelési minőséget választja ki. _Lásd_ [Renderelési profil](../fundamentals/render-profile.md "mention")
...
* **Colour** – a vágási pontok színe. _Lásd még_ [Színbeállítások és HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – kiválasztja a pontok renderelési profilját. _Lásd_ [Renderelési profil](../fundamentals/render-profile.md "mention")
