...
* **Colour** – a pontok színe. A rendszer figyelmen kívül hagyja, ha az _Inherit Colour_ be van kapcsolva, lásd lent. _Lásd még_ [Színbeállítások és HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – a renderelési minőséget választja ki. _Lásd_ [Render profile](../fundamentals/render-profile.md)
...
* **Colour** – a vágási pontok színe. _Lásd még_ [Színbeállítások és HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – kiválasztja a pontok renderelési profilját. _Lásd_ [Render profile](../fundamentals/render-profile.md)
