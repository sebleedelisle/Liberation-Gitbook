...
Podłącz LaserCube do komputera przewodem micro USB, a następnie znajdź go w panelu _Controller Assignment_ (zobacz [controller-assignment.md](../setting-up/controller-assignment.md)). Jeśli nie pojawi się automatycznie, kliknij przycisk _REFRESH_.
...
Przełącz LaserCube w tryb „LAN Client” i upewnij się, że w sieci znajduje się router. LaserCube otrzyma adres IP z routera i powinien pojawić się w panelu _Controller Assignment_. (Zobacz [controller-assignment.md](../setting-up/controller-assignment.md)).
