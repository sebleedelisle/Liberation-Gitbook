...
Maski programowe NIGDY nie powinny być jedyną metodą ochrony ludzi przed emisją lasera. Zawsze należy stosować fizyczne bariery lub fizyczne maskowanie między laserem a każdym miejscem, w którym może dojść do kontaktu z ludźmi. Traktuj ten system jako dodatkowy poziom zabezpieczenia lub rozwiązanie do zastosowań, które nie są krytyczne dla bezpieczeństwa (np. ochrona kamer albo projektorów), pamiętając, że każde oprogramowanie może zawieść.
{% endhint %}

***

Możesz dodać jeden lub więcej wirtualnych elementów typu mask, aby usunąć (lub zmniejszyć) emisję lasera w określonych miejscach.
