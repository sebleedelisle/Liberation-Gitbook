...
Więcej informacji znajdziesz w [◼️ Jak Liberation generuje treści laserowe](../../advanced/how-liberation-generates-laser-content.md "mention")
{% endhint %}
...
{% hint style="info" %}
W Clip Editor możesz przypisywać Creator do różnych profili renderowania, ale każdy laser przetworzy te profile zależnie od swoich ustawień skanerów. Zobacz [◼️ Presety skanera i profile renderowania](../../advanced/scanner-presets.md "mention")
{% endhint %}
