...
Więcej informacji znajdziesz w [how-liberation-generates-laser-content.md](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
{% hint style="info" %}
W edytorze klipów możesz przypisywać węzły Creator do różnych profili renderowania, ale każdy laser przetworzy te profile zależnie od swoich ustawień skanerów. Zobacz [scanner-presets.md](../../advanced/scanner-presets.md)
{% endhint %}
