...
* **Render profile** - zobacz [render-profile.md](fundamentals/render-profile.md)
* **Colour** - kolor kropki. Zobacz [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* pozycja **x** i **y** - zobacz [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - zobacz [render-profile.md](fundamentals/render-profile.md)
* **Size** - długość linii
* **Colour** - kolor linii. Zobacz [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* pozycja **x** i **y** - zobacz [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **rotation** - kąt linii w stopniach
* **resolution** - zobacz [resolution.md](fundamentals/resolution.md)
...
* **Colour** - kolor okręgu. Zobacz [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* pozycja **x** i **y** - zobacz [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **resolution** - zobacz [resolution.md](fundamentals/resolution.md)
* **Fill state** - zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - kolor wielokąta. Zobacz [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* pozycja **x** i **y** - zobacz [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - przetwarza każdy wypełniony kształt jako maskę, tj. wypełnia go czernią. To ustawienie zostanie włączone automatycznie, jeśli SVG zawiera jakiekolwiek wypełnione kształty. Jeśli nie ma wypełnionych kształtów, zostanie wyłączone. Zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - przetwarza każdy wypełniony kształt jako maskę, tj. wypełnia go czernią. To ustawienie zostanie włączone automatycznie, jeśli którykolwiek z plików SVG zawiera wypełnione kształty. Jeśli żaden ich nie zawiera, zostanie wyłączone. Zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Fill state** - zobacz [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md)
* **size** - rozmiar tekstu
* **colour -** zobacz [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md)
* pozycja **x** i **y** - zobacz [co-ordinate-system.md](fundamentals/co-ordinate-system.md)
* **rotation** - kąt obrotu obrazu w stopniach
* **resolution** - zobacz [resolution.md](fundamentals/resolution.md)
