...
Przesuwa całą zawartość wzdłuż osi x, y i/lub z. Pamiętaj, że układ współrzędnych jest wyśrodkowany i obejmuje zakres od +/-200 na osiach x i y. Zobacz [co-ordinate-system.md](../fundamentals/co-ordinate-system.md).
...
Obraca całą zawartość. Wartości są podawane w stopniach. Zobacz [co-ordinate-system.md](../fundamentals/co-ordinate-system.md).
