...
Bardzo skuteczne jest dodanie zone delay do już odtwarzanego Clip — użyj odpowiedniej kontrolki na APC40, aby regulować poziom i wzór. (Zobacz [Referencja APC40](../reference/apc40-reference.md "mention")). Możesz też użyć panelu _Clip Settings_.
...
Gdy Clip ma dowolny rodzaj _Zone delay_, w jego prawym górnym rogu zobaczysz ikonę trzech kropek. Kropki są animowane, aby pokazać styl _Zone delay_ dla tego Clip. Więcej szczegółów znajdziesz w [Co oznaczają małe ikony na przyciskach Clip?](what-are-the-small-icons-on-the-clip-buttons.md "mention").
