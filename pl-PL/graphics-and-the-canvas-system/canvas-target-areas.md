...
W Clip Deck, obok przycisków stref beam, znajdują się przyciski obszarów docelowych Canvas. Aby je zobaczyć, może być konieczne przewinięcie przycisków wyjściowych — użyj `Shift + Left / Right Arrow`, przycisków ZONE PAGE na ekranie albo przycisków APC40 (zobacz [Referencja APC40](../reference/apc40-reference.md "mention")).
