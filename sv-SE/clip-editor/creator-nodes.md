...
* **Colour** - punktens färg. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x**- och **y**-position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Render profile** - se [render-profile.md](fundamentals/render-profile.md "mention")
* **Size** - linjens längd
* **Colour** - linjens färg. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x**- och **y**-position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Colour** - cirkelns färg. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x**- och **y**-position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
* **resolution** - se [resolution.md](fundamentals/resolution.md "mention")
...
* **Colour** - polygonens färg. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x**- och **y**-position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Use fills as masks** - behandlar alla fyllda former som masker, dvs fyllda med svart. Detta aktiveras automatiskt om din SVG innehåller fyllda former. Om den inte innehåller några fyllda former inaktiveras det. Se [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Use fills as masks** - behandlar alla fyllda former som masker, dvs fyllda med svart. Detta aktiveras automatiskt om någon av dina SVG:er innehåller fyllda former. Om ingen innehåller fyllda former inaktiveras det. Se [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md "mention")
