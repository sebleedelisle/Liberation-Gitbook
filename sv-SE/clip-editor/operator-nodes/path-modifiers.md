...
* **Colour** – punktens färg. Ignoreras om _Inherit Colour_ är aktiverat, se nedan. _Se även_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – väljer renderingskvalitet. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
...
* **Colour** – trimningspunkternas färg. _Se även_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – väljer renderingsprofil för punkterna. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
