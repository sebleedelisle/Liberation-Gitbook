...
* **change render profile for trail** – om detta är på använder alla trail-kopior vald **render profile**. _Se_ [Render profile](../fundamentals/render-profile.md "mention").
