...
* **Scanner sync** (sometimes known as _blank shift, previously Colour Shift_) The scanners move the laser around really fast but usually the change of brightness and colour is out of sync with the movement. This shows up as little flickering "tails" of light on the edge of beams and lines. Use this adjustment to get the movement and colour in synch with each other. See [laser-settings.md](setting-up/laser-settings.md "mention")
