...
* **Scanner sync**（有時稱為 _blank shift_，之前稱為 Colour Shift）Scanners 會非常快速地移動雷射，但亮度和顏色的變化通常會與移動不同步。這會在 beams 和 lines 邊緣顯示為細小閃爍的光「尾巴」。使用此調整可令移動和顏色彼此同步。請參閱 [Laser Settings](../setting-up/laser-settings/ "mention")
