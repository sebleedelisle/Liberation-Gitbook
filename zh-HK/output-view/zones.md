...
{% hint style="danger" %}
**警告 - 激光器運行時移動 zone 必須極度小心**，並將亮度調到最低。關於如何安全啟用激光器及設定 zone，請參閱[激光設定流程概覽](../setting-up/setting-up-lasers.md)的完整指南。
{% endhint %}
...
{% hint style="info" %}
小貼士：你可以快速將 zone 設定複製到多部激光器！請參閱[在激光器之間複製設定](../setting-up/copy-laser-settings.md)
{% endhint %}
...
點擊 _Add existing canvas zone_ 按鈕後，你會看到可用的 canvas zone 清單，並可為這部激光器開啟或關閉它們。請參閱[圖形與 Canvas 系統](../graphics-and-the-canvas-system/)
