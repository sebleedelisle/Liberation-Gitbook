...
用此項選擇預先設計的 scanner 設定。預設選項通常已足夠，所以除非你的 scanners 特別差（或特別好），否則不需要更改此設定。如果想深入了解，請參閱 [◼️ Scanner 預設與 render profiles](../../advanced/scanner-presets.md "mention")
...
你不應需要調整這些設定；但如果你有興趣了解，請參閱 [◼️ 進階激光設定](../../advanced/advanced-laser-settings.md "mention")
