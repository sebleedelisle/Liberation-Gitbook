...
3.  **調整 zones：**\
    在 _OUTPUT_ view 中，你可以檢查 zones。使用 Tab 在各部雷射之間切換，或按視圖頂部其中一個編號按鈕。按需要調整每個 zone，甚至可以加入新的 zones。請參閱 [Output 檢視](../output-view/ "mention")。

    <figure><img src="../.gitbook/assets/Laser Output View.png" alt="" width="375"><figcaption></figcaption></figure>
4.  **更改每個 clip 的 zones：**\
按一下 Clip 的按鈕來觸發它，然後使用畫面上的按鈕切換 zones 以及 X 和 Y flip。請參閱 [Clips 及 Clip Deck](../clips/ "mention")。

    \\

    <figure><img src="../.gitbook/assets/Y.png" alt=""><figcaption></figcaption></figure>
5.  **連接你的 controllers：** 準備好接駁雷射並開始使用時，開啟 _Controller Assignment_ panel。請參閱 [控制器指派](controller-assignment.md "mention")。
