...
* **Colour** – 點的顏色。如已啟用 _Inherit Colour_，此設定會被忽略；詳見下方。_另請參閱_ [顏色設定及 HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – 選擇渲染質素。_請參閱_ [Render Profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – 修剪點的顏色。_另請參閱_ [顏色設定及 HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – 選擇點的 render profile。_請參閱_ [Render Profile](../fundamentals/render-profile.md "mention")
