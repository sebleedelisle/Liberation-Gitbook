...
將 LaserCube 設定為 "LAN Client" 模式，並確保網絡上有一部路由器。LaserCube 會從路由器取得 IP 地址，然後應該會在 _Controller Assignment_ panel 中出現。（見 [控制器分配](../setting-up/controller-assignment.md)）。
