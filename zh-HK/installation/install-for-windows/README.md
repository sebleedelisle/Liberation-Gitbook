...
適用於 Windows 10 或 11 的 64-bit 電腦。如果你想運行大型演出，建議使用較高規格的電腦。電腦速度越快，動畫激光輸出就會越流暢。
...
{% hint style="info" %}
在某些情況下，你可能會看到「Windows protected your PC」之類的警告——Windows 對執行新軟件比較謹慎！隨着更多人執行並信任 Liberation，這個提示應該會消失。

如果你看到這個警告，請按 _More info_ 連結，確認 _Publisher_ 顯示為 _SEB.LY LIMITED_，然後按 _Run anyway_。
...
安裝程式開始前，你可能會看到警告，詢問你是否允許安裝程式作出變更。按 _Yes_。
