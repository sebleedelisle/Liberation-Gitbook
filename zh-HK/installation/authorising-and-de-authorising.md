...
恭喜！你的 Liberation 安裝現在已完成授權，可以輸出到雷射！但在啟用雷射之前，請先閱讀[快速入門指南](../getting-started.md)和[雷射設定流程概覽](../setting-up/setting-up-lasers.md)。
...
**在 Liberation 內操作** - 開啟選單 _Liberation -> Authorise / De-authorise this Computer_，然後按一下 _DEAUTHORISE COMPUTER_ 按鈕。就是這樣！此操作需要連線到互聯網。
