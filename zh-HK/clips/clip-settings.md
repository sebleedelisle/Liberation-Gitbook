...
如果你在 Clip 上按右鍵，會顯示一個選單，內有該 Clip 的部分選項。關於此選單前幾項的更多資料，請參閱 [Clip Editor 簡介](../clip-editor/clip-editor-intro.md)、[Clip 設定](clip-settings.md) 及 [群組](groups.md)。

<figure><img src="../.gitbook/assets/Screenshot 2025-01-14 at 11.22.48.png" alt="" width="322"><figcaption><p>Clip 設定右鍵選單</p></figcaption></figure>
...
Clips 可以設定以秒為單位的淡入及淡出時間。預設情況下，fade time 會繼承其 group 設定（可在 group 按鈕上按右鍵更改）。
