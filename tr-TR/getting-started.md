...
Menüde tüm dosya içe/dışa aktarma seçeneklerini ve panelleri açma komutlarını bulabilirsiniz. Bilgisayarı lisansınızla yetkilendirme seçeneği de burada bulunur (_Liberation -> Authorise/Deauthorise this computer_).
