...
* Panel ikiye ayrılmıştır: solda lazerlerin listesi, sağda ise kullanılabilir denetleyicilerin listesi bulunur. Lazer denetleyicinizi listede görmüyorsanız _REFRESH_ düğmesine basın. Sorun yaşamaya devam ederseniz [sorun giderme](../troubleshooting/ "mention") bölümüne bakın.
...
* Turuncu kare 🟧, denetleyicinin ara sıra bağlantı sorunları yaşadığı anlamına gelir. Bu genellikle bir ağ sorunundan kaynaklanır; [sorun giderme](../troubleshooting/ "mention") bölümüne bakın.
* Kırmızı kare 🟥, denetleyiciye ulaşılamadığı anlamına gelir; [sorun giderme](../troubleshooting/ "mention") bölümüne bakın.
