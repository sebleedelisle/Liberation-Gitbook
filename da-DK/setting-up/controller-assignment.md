...
* Panelet er delt i to med en liste over lasere til venstre og listen over tilgængelige controllere til højre. Hvis du ikke kan se din lasercontroller på listen, skal du trykke på knappen _REFRESH_. Hvis du stadig har problemer, se [troubleshooting](../troubleshooting/ "mention").
...
* En orange firkant 🟧 betyder, at controlleren har periodiske forbindelsesproblemer. Det skyldes normalt et netværksproblem; se [troubleshooting](../troubleshooting/ "mention").
* En rød firkant 🟥 betyder, at controlleren ikke kan nås; se [troubleshooting](../troubleshooting/ "mention").
