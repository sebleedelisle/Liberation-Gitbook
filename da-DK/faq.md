...
Ja - Liberation understøtter fuldt ud **Windows 10 og 11 (64-bit)** med præcis de samme funktioner som Mac-versionen. Alle udgivelser kommer samtidig til begge platforme.

#### **Kører Liberation på Mac**

Ja - Liberation understøtter fuldt ud **Mac (macOS 12 Monterey og nyere)** med fuld funktionsparitet med Windows-versionen. Alle opdateringer udgives samtidig.

#### **Hvad er minimumskravene til computeren?**

Det afhænger af, hvor mange lasere du vil styre. Hvis du kun kører nogle få lasere, kan du sagtens klare dig med en mindre kraftig computer. Alle Apple Silicon Mac-computere kører rigtig godt og bør kunne styre op til 100 lasere. Hvis du kører komplekse shows, hvor meget afhænger af stabiliteten, anbefaler vi den bedste computer, dit budget tillader.
...
Liberation understøtter også APC Mini og MIDI Fighter Twister. APC40 Mk2 er stadig den mest komplette reference-controller.
...
Til andre controllere kan du bruge MIDI Send/Receive-systemet eller en MIDI-oversætter, der kan sende Liberations standard-MIDI-beskeder. Søg i [forum](https://forum.liberationlaser.com) efter råd om denne opsætning, men realistisk set er APC40 Mk2 stadig den bedste løsning til de fleste liveshows.
...
* [Mercury by X-Laser](https://x-laser.com/pages/mercury-laser-control-system) (du skal muligvis opdatere din firmware)
...
Hvis din laser har en af følgende, kan du bruge den med Liberation:

* En ekstern **ILDA-indgang** – et 25-benet D-stik, der bruges med en kompatibel ekstern controller.
...
Se siden [shop](https://liberationlaser.com/shop) for aktuelle priser.
...
Bemærk, at du kan opsætte, forhåndsvise og designe shows med så mange lasere, du vil, på **alle** niveauer, også det gratis, og der er ingen andre begrænsninger overhovedet bortset fra antallet af lasere, du kan _arm_. Alle andre Liberation-funktioner er tilgængelige for alle.
...
Hver gang licensen fornyes, skal du forbinde Liberation til internettet for at opdatere den interne licens. Ved en månedlig tilbagevendende betaling skal du forbinde hver måned.

#### **Hvad sker der, hvis jeg ikke kan forbinde min computer til internettet efter fornyelse?**

Liberation giver dig en frist på 7 dage efter licensfornyelsen til at forbinde til internettet og opdatere den interne licens. Efter den periode går Liberation tilbage til _Free_-tilstand.

#### **Hvad sker der, hvis mit kreditkort udløber?**

Du får en e-mailnotifikation fra vores betalingsudbyder, og du skal opdatere dine betalingsoplysninger. Log ind på websitet, og brug linket _Update payment details_ på abonnementssiden.

#### **Hvordan opsiger jeg min tilbagevendende licens?**

Log ind på websitet, åbn siden _Your subscriptions_, vælg det abonnement, du vil opsige, og klik derefter på linket _Cancel Subscription_. Du kan fortsætte med at bruge Liberation i resten af licensperioden.
...
* Sørg for, at du er forbundet til internettet, og klik på knappen _De-authorise this computer_ på _About_-skærmen
...
Du kan deautorisere computeren via websitet. Hvis Liberation-installationen ikke har været online siden din seneste fornyelse, kan det gøres med det samme.

Hvis ikke, træder deautoriseringen i kraft, når abonnementet fornyes, eller når computeren forbinder til internettet, alt efter hvad der sker først. Hvis du hurtigt har brug for at autorisere en ny computer igen, så kontakt support.
