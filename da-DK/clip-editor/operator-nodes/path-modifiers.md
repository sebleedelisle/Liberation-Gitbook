...
* **Colour** – prikkernes farve. Ignoreres, hvis _Inherit Colour_ er aktiveret, se nedenfor. _Se også_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – vælger renderingskvaliteten. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
...
* **Colour** – farven på beskæringsprikkerne. _Se også_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – vælger renderprofilen for prikkerne. _Se_ [render-profile.md](../fundamentals/render-profile.md "mention")
