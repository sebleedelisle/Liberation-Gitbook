...
* **Colour** - prikkens farve. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x** og **y** position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Render profile** - se [render-profile.md](fundamentals/render-profile.md "mention")
* **Size** - linjens længde
* **Colour** - linjens farve. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x** og **y** position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Colour** - cirklens farve. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x** og **y** position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
* **resolution** - se [resolution.md](fundamentals/resolution.md "mention")
...
* **Colour** - polygonens farve. Se [colour-settings-and-hsb.md](fundamentals/colour-settings-and-hsb.md "mention")
* **x** og **y** position - se [co-ordinate-system.md](fundamentals/co-ordinate-system.md "mention")
...
* **Use fills as masks** - behandler alle udfyldte former som en maske, dvs. udfyldt med sort. Dette aktiveres automatisk, hvis din SVG har udfyldte former. Hvis den ikke har udfyldte former, deaktiveres det. Se [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Use fills as masks** - behandler alle udfyldte former som en maske, dvs. udfyldt med sort. Dette aktiveres automatisk, hvis nogen af dine SVG'er har udfyldte former. Hvis ingen har udfyldte former, deaktiveres det. Se [fills-masks-and-depth-sorting.md](fundamentals/fills-masks-and-depth-sorting.md "mention")
