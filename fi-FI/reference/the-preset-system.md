...
{% hint style="info" %}
Jos sinulla on paljon lasereita ja haluat päivittää kaikkien skanneriasetukset, käytä _COPY LASER SETTINGS_ -järjestelmää. Katso [Kopioi asetukset lasereiden välillä](../setting-up/copy-laser-settings.md "mention")
{% endhint %}
