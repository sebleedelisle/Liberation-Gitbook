...
Lisätietoja: [◼️ Miten Liberation luo lasersisältöä](../../advanced/how-liberation-generates-laser-content.md "mention")
{% endhint %}
...
{% hint style="info" %}
Clip editorissa voit määrittää Creatorit eri renderöintiprofiileihin, mutta jokainen laser käsittelee näitä profiileja omien skanneriasetustensa mukaan. Katso [◼️ Skanneriesiasetukset ja renderöintiprofiilit](../../advanced/scanner-presets.md "mention")
{% endhint %}
