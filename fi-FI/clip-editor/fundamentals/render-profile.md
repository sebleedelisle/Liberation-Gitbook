...
Lisätietoja: [◼️ Miten Liberation luo lasersisältöä](../../advanced/how-liberation-generates-laser-content.md)
{% endhint %}
...
{% hint style="info" %}
Clip editorissa voit määrittää creatorit eri renderöintiprofiileihin, mutta jokainen laser käsittelee näitä profiileja omien skanneriasetustensa mukaan. Katso [◼️ Skanneriesiasetukset ja renderöintiprofiilit](../../advanced/scanner-presets.md)
{% endhint %}
