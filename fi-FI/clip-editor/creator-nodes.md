...
* **Render profile** - katso [Render Profile](fundamentals/render-profile.md)
* **Colour** - pisteen väri. Katso [Väriasetukset ja HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- ja **y**-sijainti - katso [Koordinaatisto](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - katso [Render Profile](fundamentals/render-profile.md)
* **Size** - viivan pituus
* **Colour** - viivan väri. Katso [Väriasetukset ja HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- ja **y**-sijainti - katso [Koordinaatisto](fundamentals/co-ordinate-system.md)
* **rotation** - viivan kulma asteina
* **resolution** - katso [Resoluutio](fundamentals/resolution.md)
...
* **Render profile** - katso [Render Profile](fundamentals/render-profile.md)
* **radius** - ympyrän säde
* **Colour** - ympyrän väri. Katso [Väriasetukset ja HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- ja **y**-sijainti - katso [Koordinaatisto](fundamentals/co-ordinate-system.md)
* **resolution** - katso [Resoluutio](fundamentals/resolution.md)
* **Fill state** - katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - monikulmion väri. Katso [Väriasetukset ja HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- ja **y**-sijainti - katso [Koordinaatisto](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - käsittelee kaikki täytetyt muodot maskeina, eli mustalla täytettyinä. Tämä asetetaan automaattisesti, jos SVG:ssä on täytettyjä muotoja. Jos täytettyjä muotoja ei ole, asetus poistetaan käytöstä. Katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - käsittelee kaikki täytetyt muodot maskeina, eli mustalla täytettyinä. Tämä asetetaan automaattisesti, jos jossakin SVG:ssä on täytettyjä muotoja. Jos missään ei ole täytettyjä muotoja, asetus poistetaan käytöstä. Katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Fill state** - katso [Täytöt, maskit ja syvyyslajittelu](fundamentals/fills-masks-and-depth-sorting.md)
* **size** - tekstin koko
* **colour -** katso [Väriasetukset ja HSB](fundamentals/colour-settings-and-hsb.md)
* **x**- ja **y**-sijainti - katso [Koordinaatisto](fundamentals/co-ordinate-system.md)
* **rotation** - kuvan kiertokulma asteina
* **resolution** - katso [Resoluutio](fundamentals/resolution.md)
