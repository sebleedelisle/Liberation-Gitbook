...
* **Colour** – pisteiden väri. Ohitetaan, jos _Inherit Colour_ on käytössä, katso alla. _Katso myös_ [Väriasetukset ja HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – valitsee renderöinnin laadun. _Katso_ [Render Profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – rajauspisteiden väri. _Katso myös_ [Väriasetukset ja HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – valitsee pisteiden renderöintiprofiilin. _Katso_ [Render Profile](../fundamentals/render-profile.md "mention")
