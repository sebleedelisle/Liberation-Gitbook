...
Clip deckissä beam zone -painikkeiden vieressä näkyvät Canvas-kohdealueiden painikkeet. Saatat joutua vierittämään output-painikkeita nähdäksesi ne. Käytä `Shift + Left / Right Arrow` -näppäimiä, näytön ZONE PAGE -painikkeita tai APC40-painikkeita (katso [apc40-reference.md](../reference/apc40-reference.md))
