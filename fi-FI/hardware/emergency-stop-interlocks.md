...
Siksi lasereissa on sisäänrakennetut interlock- ja etäpysäytysjärjestelmät, joilla laser voidaan poistaa käyttövalmiudesta ja ottaa käyttöön hallitusti.
{% endhint %}
