...
Siksi lasereissa on sisäänrakennetut turvalukitus- ja etäpysäytysjärjestelmät, joilla laser voidaan poistaa käyttövalmiudesta ja ottaa käyttöön hallitusti.
{% endhint %}

**Käytä aina etäpysäytyspainikkeita**, myös silloin kun käytät lasereita yksityisissä, hallituissa tiloissa. Et koskaan tiedä, milloin joku saattaa sattumalta kävellä lasersäteen tielle tai milloin odottamaton voimakas säde alkaa polttaa seinäpintaa (älä kysy, mistä tiedän).
