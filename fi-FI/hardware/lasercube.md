...
Liitä LaserCube tietokoneeseen micro USB -kaapelilla ja etsi se sitten _Controller Assignment_ -paneelista (katso [Ohjaimen määritys](../setting-up/controller-assignment.md "mention")). Jos se ei tule näkyviin automaattisesti, paina _REFRESH_-painiketta.
...
Aseta LaserCube "LAN Client" -tilaan ja varmista, että verkossa on reititin. LaserCube saa IP-osoitteen reitittimeltä, minkä jälkeen sen pitäisi näkyä _Controller Assignment_ -paneelissa. (Katso [Ohjaimen määritys](../setting-up/controller-assignment.md "mention")).
