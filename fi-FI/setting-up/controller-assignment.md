...
Kun olet määrittänyt laserit Liberationissa, voit liittää jokaisen niistä fyysiseen laserohjaimeen. (Katso kohdasta [Yhteensopivat laserit ja ohjaimet (DACit)](../hardware/compatible-lasers-and-controllers-dacs.md), mitä laitteistoa voit käyttää.) Ohjaimet yhdistetään joko USB:n kautta tai verkon yli.
...
* Paneeli on jaettu kahteen osaan: vasemmalla on laserien luettelo ja oikealla käytettävissä olevien ohjaimien luettelo. Jos laserohjaimesi ei näy luettelossa, paina _REFRESH_ -painiketta. Jos ongelma jatkuu, katso [Vianmääritys](../troubleshooting/).
...
* Oranssi neliö 🟧 tarkoittaa, että ohjaimella on ajoittaisia yhteysongelmia. Tämä johtuu yleensä verkko-ongelmasta; katso [Vianmääritys](../troubleshooting/).
* Punainen neliö 🟥 tarkoittaa, ettei ohjaimeen saada yhteyttä; katso [Vianmääritys](../troubleshooting/).
