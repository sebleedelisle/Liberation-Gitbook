...
Kun olet määrittänyt laserit Liberationissa, voit liittää jokaisen niistä fyysiseen laserohjaimeen. (Katso kohdasta [compatible-lasers-and-controllers-dacs.md](../hardware/compatible-lasers-and-controllers-dacs.md), mitä laitteistoa voit käyttää.) Ohjaimet yhdistetään joko USB:n kautta tai verkon yli.
...
* Paneeli on jaettu kahteen osaan: vasemmalla on laserien luettelo ja oikealla käytettävissä olevien ohjaimien luettelo. Jos laserohjaimesi ei näy luettelossa, paina _REFRESH_ -painiketta. Jos ongelma jatkuu, katso [troubleshooting](../troubleshooting/).
...
* Oranssi neliö 🟧 tarkoittaa, että ohjaimella on ajoittaisia yhteysongelmia. Tämä johtuu yleensä verkko-ongelmasta; katso [troubleshooting](../troubleshooting/).
* Punainen neliö 🟥 tarkoittaa, ettei ohjaimeen saada yhteyttä; katso [troubleshooting](../troubleshooting/).
