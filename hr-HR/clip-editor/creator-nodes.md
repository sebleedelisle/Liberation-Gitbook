...
* **Render profile** - pogledajte [Profil renderiranja](fundamentals/render-profile.md)
* **Colour** - boja točke. Pogledajte [Postavke boje i HSB](fundamentals/colour-settings-and-hsb.md)
* položaj **x** i **y** - pogledajte [Koordinatni sustav](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - pogledajte [Ispune, mask elementi i sortiranje po dubini](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Render profile** - pogledajte [Profil renderiranja](fundamentals/render-profile.md)
* **Size** - duljina linije
* **Colour** - boja linije. Pogledajte [Postavke boje i HSB](fundamentals/colour-settings-and-hsb.md)
* položaj **x** i **y** - pogledajte [Koordinatni sustav](fundamentals/co-ordinate-system.md)
* **rotation** - kut linije, u stupnjevima
* **resolution** - pogledajte [Rezolucija](fundamentals/resolution.md)
...
* **Colour** - boja kruga. Pogledajte [Postavke boje i HSB](fundamentals/colour-settings-and-hsb.md)
* položaj **x** i **y** - pogledajte [Koordinatni sustav](fundamentals/co-ordinate-system.md)
* **resolution** - pogledajte [Rezolucija](fundamentals/resolution.md)
* **Fill state** - pogledajte [Ispune, mask elementi i sortiranje po dubini](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - pogledajte [Ispune, mask elementi i sortiranje po dubini](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - boja poligona. Pogledajte [Postavke boje i HSB](fundamentals/colour-settings-and-hsb.md)
* položaj **x** i **y** - pogledajte [Koordinatni sustav](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - obrađuje svaki ispunjeni oblik kao mask element, tj. kao oblik ispunjen crnom bojom. To će se automatski postaviti ako vaš SVG sadrži ispunjene oblike. Ako nema ispunjenih oblika, bit će onemogućeno. Pogledajte [Ispune, mask elementi i sortiranje po dubini](fundamentals/fills-masks-and-depth-sorting.md)
...
{% hint style="info" %}
Za dodavanje više fontova u Liberation kopirajte .ttf ili .otf datoteke u mapu data/resources/fonts.
{% endhint %}
...
* **colour -** pogledajte [Postavke boje i HSB](fundamentals/colour-settings-and-hsb.md)
* položaj **x** i **y** - pogledajte [Koordinatni sustav](fundamentals/co-ordinate-system.md)
* **rotation** - zakrenuti kut slike, u stupnjevima
* **resolution** - pogledajte [Rezolucija](fundamentals/resolution.md)
...
* **countdown** - (na brzinu implementiran!) sustav odbrojavanja. Mijenja se svake 2 dobe, pa ako želite sekunde, provjerite da je tempo 120bpm.
* **countdown start** - broj od kojeg želite započeti odbrojavanje
* _MOVE TO FRONT / MOVE TO BACK_ - pogledajte [Ispune, mask elementi i sortiranje po dubini](fundamentals/fills-masks-and-depth-sorting.md)
