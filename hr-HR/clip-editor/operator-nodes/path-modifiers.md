...
* **Colour** – boja točaka. Zanemaruje se ako je uključeno _Inherit Colour_, pogledajte dolje. _Pogledajte i_ [Postavke boje i HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – odabire kvalitetu renderiranja. _Pogledajte_ [Profil renderiranja](../fundamentals/render-profile.md "mention")
...
* **Colour** – boja točaka skraćivanja. _Pogledajte i_ [Postavke boje i HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – odabire profil renderiranja za točke. _Pogledajte_ [Profil renderiranja](../fundamentals/render-profile.md "mention")
