...
* **change render profile for trail** – wenn aktiviert, verwenden alle Trail-Kopien das ausgewählte **render profile**. _Siehe_ [Render profile](../fundamentals/render-profile.md).
