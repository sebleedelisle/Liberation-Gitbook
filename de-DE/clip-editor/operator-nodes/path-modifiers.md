...
* **Colour** – die Farbe der Punkte. Wird ignoriert, wenn _Inherit Colour_ aktiviert ist, siehe unten. _Siehe auch_ [Farbeinstellungen und HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – wählt die Rendering-Qualität aus. _Siehe_ [Render profile](../fundamentals/render-profile.md "mention")
