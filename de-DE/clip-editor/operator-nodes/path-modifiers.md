...
* **Colour** – die Farbe der Punkte. Wird ignoriert, wenn _Inherit Colour_ aktiviert ist, siehe unten. _Siehe auch_ [Farbeinstellungen und HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – wählt die Rendering-Qualität aus. _Siehe_ [Render Profile](../fundamentals/render-profile.md)
...
* **Colour** – die Farbe der Trimmpunkte. _Siehe auch_ [Farbeinstellungen und HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – wählt das Render Profile für die Punkte aus. _Siehe_ [Render Profile](../fundamentals/render-profile.md)
