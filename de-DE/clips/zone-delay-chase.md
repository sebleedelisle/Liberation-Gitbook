...
Besonders wirkungsvoll ist es, _Zone delay_ bei einem bereits laufenden Clip hinzuzufügen. Verwende dazu den entsprechenden Regler auf der APC40, um Stärke und Pattern anzupassen. (Siehe [APC40-Referenz](../reference/apc40-reference.md)). Alternativ kannst du das _Clip Settings_-Panel verwenden.
