...
Liberation kann sehr viele Laser auf einem Computer betreiben. Es wurde mit über 100 Lasern getestet, daher hängt die Antwort ab von:
...
Liberation wurde für den beliebten APC40 Mk2 MIDI-Controller entwickelt und optimiert. Es funktioniert auch mit dem APC40 Mk1. Siehe [Live-MIDI-Controller](midi-control/live-control-with-the-apc40.md)
...
Zusätzlich gibt es das MIDI Send/Receive-System, das weitere MIDI-Steuerungsmöglichkeiten bietet. Siehe [MIDI Send/Receive](midi-control/midi-send-receive.md)

Weitere Informationen findest du unter [MIDI-Steuerung](midi-control/).

#### **Kann ich es mit jedem MIDI-Controller verwenden?**

Für andere Controller kannst du das MIDI Send/Receive-System oder einen MIDI-Translator verwenden, der die Standard-MIDI-Nachrichten von Liberation senden kann. Suche im [Forum](https://forum.liberationlaser.com) nach Hinweisen zu dieser Einrichtung – realistisch gesehen ist der APC40 Mk2 für die meisten Live-Shows aber weiterhin die beste Option.
...
Weitere Informationen findest du unter [Kompatible Laser und Controller (DACs)](hardware/compatible-lasers-and-controllers-dacs.md).
...
Ja, Liberation funktioniert direkt mit jedem LaserCube. Siehe [LaserCube](hardware/lasercube.md)
...
Du kannst jederzeit auf eine höhere Stufe upgraden. Für die verbleibende Zeit deines aktuellen bezahlten Zeitraums erhältst du eine anteilige Rückerstattung, und deine neue Lizenzstufe beginnt sofort. Siehe [Lizenz upgraden / downgraden](installation/upgrade-downgrade-your-license.md)

#### **Kann ich meine Lizenz downgraden?**

Du kannst jederzeit downgraden, aber die Änderung wird erst am Ende deines aktuellen bezahlten Zeitraums wirksam. Siehe [Lizenz upgraden / downgraden](installation/upgrade-downgrade-your-license.md)

#### **Kann ich Zahlungen für meine Lizenz pausieren?**

Ja. Die Lizenz kann zum nächsten Abonnementdatum pausiert und jederzeit wieder gestartet werden. Das ist praktisch, wenn du Liberation nur zeitweise nutzt und deine Kartendaten nicht erneut eingeben möchtest. Siehe [Zahlungen pausieren oder kündigen](installation/cancel-your-subscription.md)

#### **Wie kündige ich meine Lizenz dauerhaft?**

Du kannst deine wiederkehrende Lizenz jederzeit kündigen. Sie wird dann am Ende des aktuellen bezahlten Zeitraums automatisch deaktiviert. Siehe [Zahlungen pausieren oder kündigen](installation/cancel-your-subscription.md)

#### **Warum ist Liberation ein Abonnement?**

Kurz gesagt: So bleibt Liberation nachhaltig, wird aktiv weiterentwickelt und bleibt fair, während alle weiterhin Shows kostenlos öffnen, bearbeiten, speichern, üben und vorab ansehen können.

Ich habe hier mehr über die Überlegungen dahinter geschrieben: [Warum Liberation ein Abonnement nutzt](https://liberationlaser.com/articles/why-a-subscription).

#### **Kann ich eine unbefristete oder langfristige Lizenz für meine Installation / Tour-Produktion bekommen?**

Für Festinstallationen und Tour-Produktionen sind vorausbezahlte Jahreslizenzen (oder auch Mehrjahreslizenzen) verfügbar. Schreibe an [billing@liberationlaser.com](mailto:billing@liberationlaser.com), wenn du eine einrichten möchtest.

Unbefristete Lizenzen sind derzeit nicht verfügbar. Mehr Kontext dazu findest du unter [Warum Liberation ein Abonnement nutzt](https://liberationlaser.com/articles/why-a-subscription).

#### **Wie autorisiere ich meinen Computer mit meiner Lizenz?**

Sobald du eine Lizenz gekauft hast, kannst du den Computer direkt in der Liberation-Software autorisieren. Auf dem _About_-Bildschirm siehst du einen _Authorise_-Button, der dich auffordert, dich auf der Website anzumelden. Folge den Anweisungen auf dem Bildschirm, um die Autorisierung abzuschließen. Siehe [Autorisieren und Deautorisieren](installation/authorising-and-de-authorising.md)
...
Du kannst auch einen Computer, auf den du keinen Zugriff mehr hast, aus der Ferne deautorisieren (mit einigen Einschränkungen). Siehe [Autorisieren und Deautorisieren](installation/authorising-and-de-authorising.md)
...
Siehe [Dein Projekt einrichten](setting-up/setting-up-your-project.md) und [Laser hinzufügen / entfernen](setting-up/adding-removing-lasers.md)

#### Kann ich Zoneneinstellungen von einem Laser auf die anderen kopieren?

Ja! Siehe [Zonen zwischen Lasern kopieren](output-view/copy-zones-between-lasers.md)
...
Weitere Informationen findest du unter [Laser-Ausgabe-Einstellungen](setting-up/laser-settings.md). Informationen dazu, wie du eigene Presets erstellst, findest du unter [◼️ Scanner-Presets & Render-Profile](advanced/scanner-presets.md) (fortgeschritten, in Arbeit).

Du kannst außerdem die Farbbalance mit den Einstellungen _Colour calibration_ korrigieren. Siehe [Farbkalibrierung](advanced/colour-calibration.md) (fortgeschrittene Technik)
...
Klicke mit `Alt / Option`, um ihn zum _aktuell ausgewählten Clip_ zu machen, ohne ihn zu aktivieren. Siehe auch [Clips starten / stoppen](clips/starting-stopping-clips.md)

#### Wie kopiere ich Clips?

Klicke und ziehe bei gedrückter `Alt / Option`-Taste. Siehe auch [Dein Clip Deck organisieren](clips/organising-your-clip-deck.md)

#### Wie lösche ich Clips?

Klicke auf sie und ziehe sie aus dem Clip Deck heraus. Siehe auch [Dein Clip Deck organisieren](clips/organising-your-clip-deck.md)

#### Wie wähle ich mehrere Clips aus, lösche sie, kombiniere Clip Decks usw.?

Siehe [Dein Clip Deck organisieren](clips/organising-your-clip-deck.md)

#### Was bedeuten das kleine Mikrofonsymbol und andere Symbole auf dem Clip?

Sie zeigen dir, dass ein Clip Sound- oder MIDI-Eingang verwendet. Die 3 Punkte zeigen an, dass es eine Zonenverzögerung gibt. Siehe [Was bedeuten die kleinen Symbole auf den Clip-Buttons?](clips/what-are-the-small-icons-on-the-clip-buttons.md)
