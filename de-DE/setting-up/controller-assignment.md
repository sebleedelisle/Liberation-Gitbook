...
* Das Panel ist zweigeteilt: links siehst du die Liste der Laser, rechts die Liste der verfügbaren Controller. Wenn dein Laser-Controller nicht in der Liste angezeigt wird, drücke den Button _REFRESH_. Wenn weiterhin Probleme auftreten, siehe [Fehlerbehebung](../troubleshooting/ "mention").
...
* Ein orangefarbenes Quadrat 🟧 bedeutet, dass beim Controller zeitweise Verbindungsprobleme auftreten. Das wird normalerweise durch ein Netzwerkproblem verursacht, siehe [Fehlerbehebung](../troubleshooting/ "mention").
* Ein rotes Quadrat 🟥 bedeutet, dass der Controller nicht erreichbar ist, siehe [Fehlerbehebung](../troubleshooting/ "mention").
