...
Nachdem du die Laser in Liberation eingerichtet hast, kannst du jeden davon einem Laser-Controller in der realen Welt zuweisen. (Siehe [Kompatible Laser und Controller (DACs)](../hardware/compatible-lasers-and-controllers-dacs.md), um zu prüfen, welche Hardware du verwenden kannst.) Die Controller sind entweder per USB oder über das Netzwerk verbunden.
...
* Das Panel ist zweigeteilt: links siehst du die Liste der Laser, rechts die Liste der verfügbaren Controller. Wenn dein Laser-Controller nicht in der Liste angezeigt wird, drücke den Button _REFRESH_. Wenn weiterhin Probleme auftreten, siehe [Fehlerbehebung](../troubleshooting/).
...
* Ein orangefarbenes Quadrat 🟧 bedeutet, dass beim Controller zeitweise Verbindungsprobleme auftreten. Das wird normalerweise durch ein Netzwerkproblem verursacht, siehe [Fehlerbehebung](../troubleshooting/).
* Ein rotes Quadrat 🟥 bedeutet, dass der Controller nicht erreichbar ist, siehe [Fehlerbehebung](../troubleshooting/).
