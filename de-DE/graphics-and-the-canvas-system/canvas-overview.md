...
{% hint style="info" %}
Du kannst eine Canvas Zone auch einem Laser zuweisen, indem du in der _OUTPUT_-Ansicht auf den Button _add canvas zone_ klickst. Siehe [Zonen](../output-view/zones.md).
{% endhint %}
