...
{% hint style="info" %}
Wenn du viele Laser hast und alle ihre Scanner-Einstellungen aktualisieren möchtest, verwende das System _COPY LASER SETTINGS_. Siehe [Einstellungen zwischen Lasern kopieren](../setting-up/copy-laser-settings.md)
{% endhint %}
