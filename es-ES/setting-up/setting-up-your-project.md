...
3.  **Ajusta las zonas:**\
    En la vista _OUTPUT_ puedes comprobar las zonas. Cambia entre cada láser o haz clic en uno de los botones numerados de la parte superior de la vista. Ajusta cada zona según necesites, o incluso añade zonas nuevas. Consulta [Vista Output](../output-view/ "mention").
...
5.  **Conecta tus controladores:** cuando estés listo para conectar los láseres y empezar, abre el panel _Controller Assignment_. Consulta [Asignación de controladores](controller-assignment.md "mention").

    \\

    <figure><img src="../.gitbook/assets/Screenshot 2025-01-22 at 10.36.58.png" alt=""><figcaption></figcaption></figure>
6. **Activa y ajusta las zonas de tus láseres:** Sigue con cuidado [Resumen del proceso de configuración de láseres](setting-up-lasers.md "mention")
