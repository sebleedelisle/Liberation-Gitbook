...
En el menú encontrarás todas las opciones de importación y exportación de archivos, además de las opciones para abrir paneles. También encontrarás aquí la opción para autorizar el ordenador con tu licencia, en _Liberation -> Authorise/Deauthorise this computer_.
...
Lee el capítulo [Asignación de Controller](../setting-up/controller-assignment.md "mention") para más detalles.
