...
{% hint style="info" %}
También puedes asignar una zona de Canvas a un láser haciendo clic en el botón _add canvas zone_ en la _OUTPUT_ view. Consulta [Zonas](../output-view/zones.md).
{% endhint %}
