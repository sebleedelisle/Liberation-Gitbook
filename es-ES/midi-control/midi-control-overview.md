...
* Como controlador en directo, con el APC 40. Consulta [Control en directo con el APC40](live-control-with-the-apc40.md "mention").
...
* Como entrada interactiva en el nodo MIDI notes para crear efectos de tipo “arpa láser”. Consulta [MIDI notes](../clip-editor/operator-nodes/midi-notes.md "mention")
