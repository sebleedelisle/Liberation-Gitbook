...
Todo lo que puedes hacer en el Clip Editor puede usarse como efecto. De hecho, los efectos se editan con exactamente el mismo editor de nodes que los Clips. Consulta [Edición de efectos](effects.md#editing-effects). Las posibilidades creativas son prácticamente infinitas.
...
Añade un parámetro a tu efecto con un _Parameter node._ El sistema de parámetros permite ajustar desde fuera varios ajustes dentro de tu efecto. Consulta [Control de parámetros](clip-editor/oscillators/parameter-control.md) para obtener más información.
...
{% hint style="info" %}
Los controles giratorios 1-8 están en la parte superior de un APC40 Mk2 y en la parte superior derecha en el Mk1. Consulta también: [Referencia de APC40](reference/apc40-reference.md)
{% endhint %}
...
Edita tu efecto del mismo modo que editarías cualquier Clip. Consulta [El Clip Editor](clip-editor/).
