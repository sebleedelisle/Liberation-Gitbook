...
{% hint style="info" %}
Si no ves ninguna salida en el 3D Visualiser, puede que tengas que usar los botones de zona para activar las zones que quieres. También tendrás que asegurarte de que _Preview to lasers_ esté activado; consulta [Panel del Clip Editor](clip-editor-intro.md#clip-editor-panel) más abajo.
{% endhint %}
