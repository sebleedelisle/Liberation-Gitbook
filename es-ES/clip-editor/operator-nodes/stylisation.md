...
* **change render profile for trail** – si está activado, todas las copias del rastro usan el **render profile** seleccionado. _Consulta_ [Perfil de renderizado](../fundamentals/render-profile.md).
