...
* **Render Profile** – elige la calidad de renderizado. _Consulta_ [Render profile](../fundamentals/render-profile.md "mention")
...
* **Render Profile** – elige el perfil de renderizado para los puntos. _Consulta_ [Render profile](../fundamentals/render-profile.md "mention")
