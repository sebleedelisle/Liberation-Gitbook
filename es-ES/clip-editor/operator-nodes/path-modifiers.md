...
* **Colour** – el color de los puntos. Se ignora si _Inherit Colour_ está activado; consulta más abajo. _Consulta también_ [Ajustes de color y HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – elige la calidad de renderizado. _Consulta_ [Perfil de renderizado](../fundamentals/render-profile.md "mention")
...
* **Colour** – el color de los puntos de recorte. _Consulta también_ [Ajustes de color y HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – elige el perfil de renderizado para los puntos. _Consulta_ [Perfil de renderizado](../fundamentals/render-profile.md "mention")
