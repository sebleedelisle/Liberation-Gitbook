...
* **Render profile** - consulta [Perfil de renderizado](fundamentals/render-profile.md "mention")
* **Colour** - el color del punto. Consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md "mention")
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md "mention")
