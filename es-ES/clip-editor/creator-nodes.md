...
* **Render profile** - consulta [Perfil de renderizado](fundamentals/render-profile.md)
* **Colour** - el color del punto. Consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md)
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - consulta [Rellenos, máscaras y ordenación por profundidad](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - el color de la línea. Consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md)
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
* **rotation** - el ángulo de la línea, en grados
* **resolution** - consulta [Resolución](fundamentals/resolution.md)
...
* **Colour** - el color del círculo. Consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md)
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
* **resolution** - consulta [Resolución](fundamentals/resolution.md)
* **Fill state** - consulta [Rellenos, máscaras y ordenación por profundidad](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - consulta [Rellenos, máscaras y ordenación por profundidad](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - el color del polígono. Consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md)
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - procesa cualquier forma rellena como una mask, es decir, rellenada en negro. Se activará automáticamente si tu SVG tiene alguna forma rellena. Si no tiene formas rellenas, se desactivará. Consulta [Rellenos, máscaras y ordenación por profundidad](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** consulta [Ajustes de color y HSB](fundamentals/colour-settings-and-hsb.md)
* posición **x** e **y** - consulta [Sistema de coordenadas](fundamentals/co-ordinate-system.md)
* **rotation** - el ángulo de rotación de la imagen, en grados
* **resolution** - consulta [Resolución](fundamentals/resolution.md)
