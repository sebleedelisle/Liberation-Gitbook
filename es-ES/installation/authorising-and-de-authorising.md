...
### Autorizar Liberation

Cuando abras Liberation por primera vez, se ejecutará en _free mode_ y verás el panel _About_:
...
¡Enhorabuena! Tu instalación de Liberation ya está autorizada y puedes enviar salida a los láseres. Pero lee la [Guía de inicio rápido](../getting-started.md) y el [Resumen del proceso de configuración de láseres](../setting-up/setting-up-lasers.md) antes de armar los láseres.
...
### Desautorizar Liberation

**Desde Liberation**: abre el menú _Liberation -> Authorise / De-authorise this Computer_ y haz clic en el botón _DEAUTHORISE COMPUTER_. ¡Eso es todo! Necesitas estar conectado a Internet para que funcione.
