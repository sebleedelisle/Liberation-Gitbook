...
{% hint style="info" %}
Si tienes muchos láseres y quieres actualizar todos sus ajustes de escáner, usa el sistema _COPY LASER SETTINGS_. Consulta [Copiar ajustes entre láseres](../setting-up/copy-laser-settings.md)
{% endhint %}
