...
{% hint style="info" %}
Vous pouvez aussi assigner une zone du Canvas à un laser en cliquant sur le bouton _add canvas zone_ dans la vue _OUTPUT_. Voir [Zones](../output-view/zones.md).
{% endhint %}
