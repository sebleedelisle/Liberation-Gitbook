...
Voir [#copy-laser-settings](laser-settings.md#copy-laser-settings "mention").
...
{% hint style="info" %}
Ce paramètre de vitesse ne change pas le taux de points ; il ajuste plutôt l’espacement de ces points. Pour plus d’informations, consultez [how-liberation-generates-laser-content.md](../advanced/how-liberation-generates-laser-content.md "mention")
{% endhint %}
...
Utilisez ce réglage pour choisir un paramètre de scanner prédéfini. L’option par défaut convient généralement, vous ne devriez donc pas avoir besoin de modifier ce paramètre, sauf si vous avez des scanners particulièrement mauvais (ou bons). Si vous voulez aller plus loin, consultez [scanner-presets.md](../advanced/scanner-presets.md "mention")
...
Vous ne devriez pas avoir besoin de toucher à ces paramètres, mais si vous êtes curieux, consultez [advanced-laser-settings.md](../advanced/advanced-laser-settings.md "mention")
