...
* **Render profile** - voir [Profil de rendu](fundamentals/render-profile.md)
* **Colour** - la couleur du point. Voir [Paramètres de couleur et HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - voir [Système de coordonnées](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - voir [Remplissages, masques et tri en profondeur](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - la couleur de la ligne. Voir [Paramètres de couleur et HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - voir [Système de coordonnées](fundamentals/co-ordinate-system.md)
* **rotation** - l’angle de la ligne, en degrés
* **resolution** - voir [Résolution](fundamentals/resolution.md)
...
* **Colour** - la couleur du cercle. Voir [Paramètres de couleur et HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - voir [Système de coordonnées](fundamentals/co-ordinate-system.md)
* **resolution** - voir [Résolution](fundamentals/resolution.md)
* **Fill state** - voir [Remplissages, masques et tri en profondeur](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - voir [Remplissages, masques et tri en profondeur](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Colour** - la couleur du polygone. Voir [Paramètres de couleur et HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - voir [Système de coordonnées](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - traite toute forme remplie comme un masque, c.-à-d. comme si elle était remplie en noir. Cette option est activée automatiquement si votre SVG contient des formes remplies. S’il ne contient aucune forme remplie, elle est désactivée. Voir [Remplissages, masques et tri en profondeur](fundamentals/fills-masks-and-depth-sorting.md)
...
* **colour -** voir [Paramètres de couleur et HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - voir [Système de coordonnées](fundamentals/co-ordinate-system.md)
* **rotation** - l’angle de rotation de l’image, en degrés
* **resolution** - voir [Résolution](fundamentals/resolution.md)
