...
* **change render profile for trail** – si l’option est activée, toutes les copies de traînée utilisent le **render profile** sélectionné. _Voir_ [Profil de rendu](../fundamentals/render-profile.md).
