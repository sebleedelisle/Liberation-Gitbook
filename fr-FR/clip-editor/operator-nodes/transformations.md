...
Déplace tout le contenu le long des axes x, y et/ou z. Notez que le système de coordonnées est centré et s’étend de +/-200 sur les axes x et y. Voir [Système de coordonnées](../fundamentals/co-ordinate-system.md).
...
Fait pivoter tout le contenu. Les valeurs sont exprimées en degrés. Voir [Système de coordonnées](../fundamentals/co-ordinate-system.md).
