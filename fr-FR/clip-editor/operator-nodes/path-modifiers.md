...
* **Colour** – la couleur des points. Ignorée si _Inherit Colour_ est activé, voir ci-dessous. _Voir aussi_ [Paramètres de couleur et HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – choisit la qualité de rendu. _Voir_ [Profil de rendu](../fundamentals/render-profile.md)
...
* **Colour** – la couleur des points de découpe. _Voir aussi_ [Paramètres de couleur et HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – choisit le profil de rendu pour les points. _Voir_ [Profil de rendu](../fundamentals/render-profile.md)
