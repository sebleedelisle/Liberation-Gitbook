...
* **Colour** – la couleur des points. Ignorée si _Inherit Colour_ est activé, voir ci-dessous. _Voir aussi_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – choisit la qualité de rendu. _Voir_ [render-profile.md](../fundamentals/render-profile.md "mention")
...
* **Colour** – la couleur des points de découpe. _Voir aussi_ [colour-settings-and-hsb.md](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – choisit le profil de rendu pour les points. _Voir_ [render-profile.md](../fundamentals/render-profile.md "mention")
