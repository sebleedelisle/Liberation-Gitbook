...
* **Render Profile** – choisit la qualité de rendu. _Voir_ [Profil de rendu](../fundamentals/render-profile.md "mention")
...
* **Render Profile** – choisit le profil de rendu pour les points. _Voir_ [Profil de rendu](../fundamentals/render-profile.md "mention")
