...
Une fois Liberation installé sur votre ordinateur, il fonctionne en _mode démo_ jusqu’à ce que vous l’_autorisiez_.
...
En plus du nombre de lasers que vous pouvez armer, vous pouvez également utiliser des appareils DMX. Voir [dmx-control](../dmx-control/ "mention").
