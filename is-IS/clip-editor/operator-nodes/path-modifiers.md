...
* **Colour** – litur punktanna. Hunsað ef _Inherit Colour_ er virkt, sjá hér að neðan. _Sjá einnig_ [litastillingar og HSB](../fundamentals/colour-settings-and-hsb.md "mention")
...
* **Render Profile** – velur rendering-gæðin. _Sjá_ [Render profile](../fundamentals/render-profile.md "mention")
...
* **Colour** – litur klippipunktanna. _Sjá einnig_ [litastillingar og HSB](../fundamentals/colour-settings-and-hsb.md "mention")
* **Render Profile** – velur render profile fyrir punktana. _Sjá_ [Render profile](../fundamentals/render-profile.md "mention")
