...
Liberation hefur verið hannað og fínstillt fyrir hinn vinsæla APC40 Mk2 MIDI controller. Það virkar einnig með APC40 Mk1. Sjá [Stýring í rauntíma með APC40](midi-control/live-control-with-the-apc40.md)

Við erum smám saman að bæta við fleiri MIDI controllers og styðjum nú einnig APC Mini Mk2 og MIDI Fighter Twister.

Það er líka MIDI Send/Receive-kerfið sem býður upp á viðbótarstýringu með MIDI. Sjá [MIDI Send/Receive](midi-control/midi-send-receive.md)

Sjá [MIDI-stýring](midi-control/) fyrir frekari upplýsingar.

#### **Get ég notað hvaða MIDI controller sem er?**

Við erum nú að vinna að stillanlegu MIDI-kerfi sem mun gera þetta mögulegt í framtíðinni. Þangað til hafa sumir notendur náð árangri með MIDI-túlki sem getur umbreytt hvaða MIDI-skilaboðum sem er fyrir MIDI Send/Receive-kerfið, en þetta er vandasamt og krefst talsverðrar reynslu. Leitaðu á [spjallsvæðinu](https://forum.liberationlaser.com) eftir ráðum um þessa uppsetningu, en í raun er APC40 besti kosturinn.
...
* LaserCube network protocol (með snúrutengingu)
* AVB eins og notað er af [LASollinger lasers](https://laseranimation.com/en/) (nú aðeins í prófun á macOS)

Sjá [Samhæfðir laserar og laser controllers (DACs)](hardware/compatible-lasers-and-controllers-dacs.md) fyrir frekari upplýsingar
...
* Ytra **ILDA input** – 25 pinna D-tengi, notað með samhæfum ytri controller.
...
Já, Liberation virkar beint með hvaða LaserCube sem er. Sjá [LaserCube](hardware/lasercube.md)
...
Þú getur uppfært í hærra þrep hvenær sem er. Þú færð hluta endurgreiddan fyrir þann tíma sem eftir er af núverandi leyfi og nýja áskriftin þín hefst strax. Sjá [Hækka eða lækka leyfisþrep](installation/upgrade-downgrade-your-license.md)

#### **Get ég lækkað leyfisþrepið mitt?**

Þú getur lækkað þrepið hvenær sem er, en breytingin tekur gildi í lok núverandi leyfistímabils. Sjá [Hækka eða lækka leyfisþrep](installation/upgrade-downgrade-your-license.md)

#### **Hvernig heimila ég tölvuna mína með leyfinu mínu?**

Þegar þú hefur keypt leyfi geturðu heimilað tölvuna innan Liberation-hugbúnaðarins sjálfs. Þú sérð _Authorise_ hnapp á _About_ skjánum sem biður þig um að skrá þig inn á vefsíðuna. Fylgdu leiðbeiningunum á skjánum til að ljúka heimildarferlinu. Sjá [Heimild veitt og fjarlægð](installation/authorising-and-de-authorising.md)
...
Þú getur sett Liberation upp á eins mörgum tölvum og þú vilt. Leyfisheimildir eru aðeins nauðsynlegar til að virkja úttak fyrir laser / DMX, og leyfisþrepið þitt ræður því hversu margar tölvur geta verið heimilaðar fyrir úttak í einu. Sjá [Hvernig leyfakerfið virkar](installation/how-licensing-works.md)
...
Þú getur einnig fjarlægt heimild af tölvu í fjarska ef þú hefur ekki lengur aðgang að henni (með nokkrum takmörkunum). Sjá [Heimild veitt og fjarlægð](installation/authorising-and-de-authorising.md)
...
Sjá [Verkefnið sett upp](setting-up/setting-up-your-project.md) og [Laserum bætt við og þeir fjarlægðir](setting-up/adding-removing-lasers.md)

#### Get ég afritað stillingar fyrir zone úr einum laser yfir í hina?

Já! Sjá [Afrita zones milli lasera](output-view/copy-zones-between-lasers.md)

#### Get ég slegið inn tölu í stað þess að nota sleða?

Já. `Cmd / Ctrl`-smelltu á sleðann og þá geturðu slegið gildið inn með lyklaborðinu.
...
Aðalstillingin er _Colour Shift,_ sem bætir upp örlitla töf milli þess að speglarnir hreyfast og þess að laserarnir breyta birtustigi. Ef punktar/geislar lasersins eru með litla „hala“ þarftu að stilla þetta. (Sjá myndirnar á síðunni [Laser Settings](setting-up/laser-settings.md) fyrir dæmi um „hala“)
...
Þetta er töf ramma, eða hámarkstími milli þess að rammi er búinn til og síðan sendur til lasers. Þú ættir ekki að þurfa að breyta þessu, en ef þú ert í vandræðum með netið geturðu prófað að hækka gildið. Sjá [stillingin Latency](setting-up/latency-setting.md) fyrir nánari upplýsingar.

### Clips

#### Hvernig laga ég zones og stillingar fyrir Clip án þess að keyra það?

`Alt / Option`-smelltu til að gera það að _Clip sem er valið núna_ án þess að virkja það. Sjá einnig [Ræsa og stöðva Clips](clips/starting-stopping-clips.md)

#### Hvernig afrita ég Clips?

Smelltu og dragðu á meðan þú heldur inni `Alt / Option` takkanum. Sjá einnig [Skipuleggja Clip Deck](clips/organising-your-clip-deck.md)

#### Hvernig eyði ég Clips?

Smelltu og dragðu þau út af Clip Deck. Sjá einnig [Skipuleggja Clip Deck](clips/organising-your-clip-deck.md)
...
Þau eru til staðar til að sýna að Clip tekur við hljóði eða MIDI inntaki, og punktarnir 3 sýna að það er töf á zone. Sjá [Hvað merkja litlu táknin á hnöppum fyrir Clip?](clips/what-are-the-small-icons-on-the-clip-buttons.md)
