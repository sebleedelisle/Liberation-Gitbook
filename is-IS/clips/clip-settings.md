...
Spjaldið hægra megin við Clip Deck sýnir átta samhengisbundnar færibreytur. Þegar Clip er valið eru fyrstu stýringarnar _Shift X_, _Shift Y_ og _Zone Delay_ fyrir valið Clip, og síðan almennu stýringarnar _Spin_ og _Scale_.

Þessar sömu færibreytur eru einnig speglaðar yfir á studda MIDI controllers. Ef ekkert Clip er valið eru reitirnir sem eiga við tiltekið Clip auðir. Ef þú heldur inni hóphnappi breytast fyrstu tvær stýringarnar í inn- og útdofnunartíma hópsins.
...
Hægt er að stilla Clips þannig að þau dofni inn og út á tíma sem er mældur í sekúndum. Sjálfgefið erfir Clip dofnunartímann frá stillingum hópsins, og honum er hægt að breyta með því að hægrismella á hóphnappinn.
