...
Eldri LaserCube-tæki eru stýrð með USB, en núverandi gerðir eru allar með innbyggða netstýringu. Þessi nettengdu tæki eru kölluð „LaserCube Wifi“. Liberation styður báðar gerðir LaserCube\*, hvort sem tengt er með USB eða yfir netkerfi.

\*(Stuðningur við netsamskiptareglur LaserCube var kynntur í útgáfu 0.7.3)
...
Beinirinn úthlutar IP-tölum sjálfkrafa á allt sem tengist, og mér finnst það einfaldara og síður líklegt til að valda villum.
{% endhint %}

{% hint style="danger" %}
Ólíkt Ether Dream þá _**SLÖKKVA LaserCube EKKI Á LASERGEISLANUM**_ ef þau lenda í biðminnisunderrennsli, glötuðum pakka eða öðrum skemmdum/röngum gögnum.

Í staðinn halda þau bara áfram frá þeim stað þar sem þau voru, og í sumum tilvikum getur það valdið því að virkur geisli fari yfir svæði sem eru ekki innan zones, og það sem verra er, hann getur farið í gegnum hugbúnaðar-masks.

Ég er í samtali við hönnuði/forritara LaserCube og vona að þeir lagi þetta í framtíðinni með firmware-uppfærslu. Þangað til verður þú að tryggja að þú setjir líkamlegar afmarkanir þar sem þú vilt ekki að leysigeislinn fari.

Sanngirnis vegna ættirðu líklega alltaf að gera þetta, en ég nota sjálfur hugbúnaðar-masks til að verja myndavélar og skjávarpa. Hafðu því í huga að þetta er hættulegra þegar netsamskiptareglur LaserCube eru notaðar en með Ether Dream, sem fer í öryggisstöðvun um leið og villa kemur upp eða gögn vantar.
