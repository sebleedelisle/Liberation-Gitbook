...
* **Color** – the color of the dots. Ignored if _Inherit Color_ is enabled, see below. _See also_ [Color settings and HSB](../fundamentals/colour-settings-and-hsb.md)
...
* **Render Profile** – chooses the rendering quality. _See_ [Render profile](../fundamentals/render-profile.md)
...
* **Color** – the color of the trim dots. _See also_ [Color settings and HSB](../fundamentals/colour-settings-and-hsb.md)
* **Render Profile** – chooses the render profile for the dots. _See_ [Render profile](../fundamentals/render-profile.md)
