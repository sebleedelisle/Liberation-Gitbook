...
These determine which aspects of the color adjustments are applied to the content. See also: [Color settings and HSB](../fundamentals/colour-settings-and-hsb.md).
...
Uses the same gradient editor as [Color change](colour-changer.md), but it maps the gradient across the content by position.
