...
* **radius** - the distance from the center point that the content is shifted before rotating.
* **count** - the number of copies of the object to make.
* **use each objects pivot point** - when selected, each element will be shifted and rotated around its own center point. (Only has an effect when there are multiple elements being duplicated)
...
* **horizontal alignment** - the starting point of the columns, LEFT, CENTER or RIGHT
