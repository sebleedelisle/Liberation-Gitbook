...
* **Render profile** - see [Render profile](fundamentals/render-profile.md "mention")
* **Color** - the color of the dot. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md "mention")
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md "mention")
* _MOVE TO FRONT / MOVE TO BACK_ - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Color** - the color of the line. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md "mention")
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md "mention")
* **rotation** - the angle of the line, in degrees
* **resolution** - see [Resolution](fundamentals/resolution.md "mention")
* **alignment** - _LEFT / CENTER / RIGHT -_ determines the start point and center of rotation of the line
* _MOVE TO FRONT / MOVE TO BACK_ - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Color** - the color of the circle. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md "mention")
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md "mention")
* **resolution** - see [Resolution](fundamentals/resolution.md "mention")
* **Fill state** - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
* _MOVE TO FRONT / MOVE TO BACK_ - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Render profile** - see [Render profile](fundamentals/render-profile.md "mention")
* **size** - the distance from the center to each of the corners
* **Color** - the color of the polygon. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md "mention")
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md "mention")
...
{% hint style="warning" %}
Liberation is compatible with the _SVGTiny_ format. InkScape is recommended but most vector graphics apps can export in this format. Make sure to convert any text to shapes before exporting. Liberation will render strokes, and optionally use fills as masks. Make sure your lines are not black or they won't show up without a color modifier!
{% endhint %}
...
* **Use fills as masks** - will process any filled shape as a mask, i.e. filled in with black. This will be set automatically if your SVG has any filled shapes. If it has no filled shapes, it will be disabled. See [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Use fills as masks** - will process any filled shape as a mask, i.e. filled in with black. This will be set automatically if any of your SVGs have filled shapes. If none have any filled shapes, it will be disabled. See [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
...
* **Render profile** - see [Render profile](fundamentals/render-profile.md "mention")
* **horizontal alignment** - choose _LEFT_, _CENTER_, or _RIGHT_ to select the text alignment.
* **Fill state** - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md "mention")
* **size** - the text size
* **color -** see [Color settings and HSB](fundamentals/colour-settings-and-hsb.md "mention")
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md "mention")
* **rotation** - the rotated angle of the image, in degrees
* **resolution** - see [Resolution](fundamentals/resolution.md "mention")
