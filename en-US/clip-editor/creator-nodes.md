...
* **Render profile** - see [Render profile](fundamentals/render-profile.md)
* **Color** - the color of the dot. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* _MOVE TO FRONT / MOVE TO BACK_ - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Color** - the color of the line. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* **rotation** - the angle of the line, in degrees
* **resolution** - see [Resolution](fundamentals/resolution.md)
...
* **Color** - the color of the circle. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* **resolution** - see [Resolution](fundamentals/resolution.md)
* **Fill state** - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md)
* _MOVE TO FRONT / MOVE TO BACK_ - see [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Color** - the color of the polygon. See [Color settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
...
* **Use fills as masks** - will process any filled shape as a mask, i.e. filled in with black. This will be set automatically if your SVG has any filled shapes. If it has no filled shapes, it will be disabled. See [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md)
...
* **Use fills as masks** - will process any filled shape as a mask, i.e. filled in with black. This will be set automatically if any of your SVGs have filled shapes. If none have any filled shapes, it will be disabled. See [Fills, masks and depth sorting](fundamentals/fills-masks-and-depth-sorting.md)
...
* **color -** see [Color settings and HSB](fundamentals/colour-settings-and-hsb.md)
* **x** and **y** position - see [Coordinate system](fundamentals/co-ordinate-system.md)
* **rotation** - the rotated angle of the image, in degrees
* **resolution** - see [Resolution](fundamentals/resolution.md)
