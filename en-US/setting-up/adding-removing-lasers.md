...
When you add a new laser, a beam zone is automatically added to it. Note that lasers and zones are sorted in the order that you add them. See [Reordering beam zones](../output-view/re-ordering-beam-zones.md).
