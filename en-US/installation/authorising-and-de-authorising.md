...
Congratulations! Your Liberation install has now been authorized and you can output to lasers! But please read the [Quick start guide](../getting-started.md) and [Laser setup process overview](../setting-up/setting-up-lasers.md) before arming your lasers.
