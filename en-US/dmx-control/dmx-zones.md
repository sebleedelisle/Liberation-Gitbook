...
The number of DMX zones that can be armed at the same time depends on your license tier. If your tier does not allow DMX output, or you have already armed the maximum number of DMX zones, the **ARM** button for additional zones is disabled and shows a no-entry icon when hovered.

Disarm another DMX zone, or use a license tier with a higher DMX limit, before arming more zones.
