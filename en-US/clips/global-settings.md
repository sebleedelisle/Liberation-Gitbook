...
Spins all content around the center. A positive value spin in the clockwise direction, a negative value spins counterclockwise. You'll see that this setting affects the _Rotation_ transformation. By default this is mapped to the APC40 Device Control knob 3 and appears in the panel to the right of the clip deck.

### Spin 3D

Spins all content around the Y axis (which is a vertical line in the center). You'll see that this setting affects the _Rotation3D_ transformation. By default this is mapped to the APC40 Device Control knob 7 and appears in the panel to the right of the clip deck.
