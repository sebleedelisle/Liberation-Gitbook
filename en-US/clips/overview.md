...
Clip content is created using the versatile node-based clip editor system. (See [Introduction to the Clip Editor](../clip-editor/clip-editor-intro.md) for more details)
