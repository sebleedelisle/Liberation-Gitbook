...
Click the _Add a new beam zone_ button at the top of the toolbar and a new zone will appear. Note that beam zones are sorted in the order that you add them but you can reorder them. See [Reordering beam zones](re-ordering-beam-zones.md)
