...
The default has 8 lasers spread out horizontally but you can customize this to whatever you want. It's probably best to keep this default while you're getting to know the software, and then later on you can adjust it to match your hardware setup. (See [Setting up your project](../setting-up/setting-up-your-project.md "mention"))&#x20;
...
The menu is where you will find all file import / export options, and to open panels. You'll also find the option to authorize the computer with your subscription here (in _Liberation -> Authorize/Deauthorize this computer_) .
...
To help you get your bearings, there is a mini visualizer of the clip deck along the top. See also [Clips & Clip deck](../clips/ "mention")
...
There are multiple synchronization options, including MIDI clock and Ableton Link. If you know the tempo of the music you can manually adjust it using the on-screen slider or the APC40 Tempo knob, but you can also keep in time with the music using the _Tap Tempo_ system\_.\_
