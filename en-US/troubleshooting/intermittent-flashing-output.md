...
* Disable the SFS (Scan Fail Safety) system. Some lasers have a function that disables output if the scanners stop moving i.e. producing a strong static beam. They can be a little overcautious / unreliable.
